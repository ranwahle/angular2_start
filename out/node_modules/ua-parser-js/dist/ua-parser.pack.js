System.registerModule("../../../../node_modules/ua-parser-js/dist/ua-parser.pack.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/ua-parser-js/dist/ua-parser.pack.js";
  (function(e, t) {
    "use strict";
    var n = "0.7.10",
        r = "",
          ...
          rgx: function() {
            ...
            while (n < h.length && !l) {
              ...
              if (typeof e === o) {
                e = {};
                for (a in d)
                  d.hasOwnProperty(a) && (f = d[a], typeof f === u ? e[f[0]] = t : e[f] = t);
              }
              r = i = 0;
              while (r < p.length && !l) {
                ...
                if (!!l)
                  for (a = 0; a < d.length; a++)
                    c = l[++i], f = d[a], typeof f === u && f.length > 0 ? f.length == 2 ? typeof f[1] == s ? e[f[0]] = f[1].call(this, c) : e[f[0]] = f[1] : f.length == 3 ? typeof f[1] === s && (!f[1].exec || !f[1].test) ? e[f[0]] = c ? f[1].call(this, c, f[2]) : t : e[f[0]] = c ? c.replace(f[1], f[2]) : t : f.length == 4 && (e[f[0]] = c ? f[3].call(this, c.replace(f[1], f[2])) : t) : e[f] = c ? c : t;
              }
              n += 2;
            }
            return e;
...
System.get("../../../../node_modules/ua-parser-js/dist/ua-parser.pack.js" + '');
