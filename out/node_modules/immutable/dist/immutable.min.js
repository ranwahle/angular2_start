System.registerModule("../../../../node_modules/immutable/dist/immutable.min.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/immutable/dist/immutable.min.js";
  !function(t, e) {
    ...
    function p(t, e) {
      e = e || 0;
      for (var r = Math.max(0, t.length - e),
          n = Array(r),
          i = 0; r > i; i++)
        n[i] = t[i + e];
      return n;
    ...
    function x(t) {
      return null === t || void 0 === t ? T().toKeyedSeq() : o(t) ? u(t) ? t.toSeq() : t.fromEntrySeq() : W(t);
    }
    function k(t) {
      return null === t || void 0 === t ? T() : o(t) ? u(t) ? t.entrySeq() : t.toIndexedSeq() : B(t);
    }
    function A(t) {
      return (null === t || void 0 === t ? T() : o(t) ? u(t) ? t.entrySeq() : t : B(t)).toSetSeq();
    }
    function j(t) {
    ...
    function W(t) {
      var e = Array.isArray(t) ? new j(t).fromEntrySeq() : q(t) ? new U(t).fromEntrySeq() : b(t) ? new R(t).fromEntrySeq() : "object" == typeof t ? new K(t) : void 0;
      if (!e)
    ...
    function C(t) {
      var e = J(t) || "object" == typeof t && new K(t);
      if (!e)
        throw new TypeError("Expected Array or iterable object of values, or keyed object: " + t);
      return e;
    }
    function J(t) {
      return E(t) ? new j(t) : q(t) ? new U(t) : b(t) ? new R(t) : void 0;
    }
    function N(t, e, r, n) {
      var i = t._cache;
      if (i) {
    ...
    function ut(t) {
      var e = Wr[t];
      return void 0 === e && (e = st(t), Tr === Lr && (Tr = 0, Wr = {}), Tr++, Wr[t] = e), e;
    }
    function st(t) {
      for (var e = 0,
          r = 0; t.length > r; r++)
    ...
    function It(t, e, r) {
      ...
      if (t._root) {
        var o = f(dr),
            u = f(mr);
        if (n = bt(t._root, t.__ownerID, 0, void 0, e, r, o, u), !u.value)
          return t;
    ...
    function Dt(t, e, r, n, i) {
      ...
      var o,
          u = (0 === r ? t.keyHash : t.keyHash >>> r) & lr,
          s = (0 === r ? n : n >>> r) & lr,
          a = u === s ? [Dt(t, e, r + pr, n, i)] : (o = new dt(e, n, i), s > u ? [t, o] : [o, t]);
      return new vt(e, 1 << u | 1 << s, a);
    }
    function Mt(t, e, r, n) {
      t || (t = new _);
      for (var i = new dt(t, ot(r), [r, n]),
          o = 0; e.length > o; o++) {
        var u = e[o];
    ...
    function Xt(t, e, r) {
      ...
      for (var a = t._level,
          h = t._root,
          f = 0; 0 > u + f; )
        h = new Ct(h && h.array.length ? [void 0, h] : [], n), a += pr, f += 1 << a;
      f && (u += f, i += f, s += f, o += f);
      for (var c = Gt(o),
          p = Gt(s); p >= 1 << a + pr; )
        h = new Ct(h && h.array.length ? [h] : [], n), a += pr;
      var v = t._tail,
      ...
      if (o > s && (l = l && l.removeAfter(n, 0, s)), u >= p)
        u -= p, s -= p, a = pr, h = null, l = l && l.removeBefore(n, 0, u);
      else if (u > i || c > p) {
        for (f = 0; h; ) {
          var g = u >>> a & lr;
          if (g !== p >>> a & lr)
    ...
    function le(t, e, r, n) {
      ...
      return i.__iterateUncached = function(i, o) {
        ...
        return new S(function() {
          ...
          do {
            if (t = s.next(), t.done)
              return n || i === wr ? t : i === gr ? z(i, h++, void 0, t) : z(i, h++, t.value[1], t);
            var c = t.value;
    ...
    function ye(t, e) {
      var n = u(t),
          i = [t].concat(e).map(function(t) {
            return o(t) ? n && (t = r(t)) : t = n ? W(t) : B(Array.isArray(t) ? t : [t]), t;
          }).filter(function(t) {
            return 0 !== t.size;
          });
      if (0 === i.length)
      ...
      return n.__iterateUncached = function(n, i) {
        ...
        return new S(function() {
          for (; u; ) {
            ...
            if (t.done === !1) {
              var h = t.value;
              if (n === Sr && (h = h[1]), e && !(e > s.length) || !o(h))
                return r ? t : z(n, a++, h, t);
    ...
    function Ie(t, r, n) {
      ...
      return i.size = new j(n).map(function(t) {
        ...
        for (var r = void 0,
            n = this.__iterator(wr, e),
            i = 0; !(r = n.next()).done && t(r.value, i++, this) !== !1; )
          ;
        return i;
      ...
      var r,
          n = function(o) {
            ...
            if (!r) {
              r = !0;
              var u = Object.keys(t);
              Re(i, u), i.size = u.length, i._name = e, i._keys = u, i._defaultValues = t;
            }
            this._map = ct(o);
          },
    ...
    O.prototype[qr] = !0, t(j, k), j.prototype.get = function(t, e) {
    ...
    }, t(K, x), K.prototype.get = function(t, e) {
      return void 0 === e || this.has(t) ? this._object[t] : e;
    }, K.prototype.has = function(t) {
      return this._object.hasOwnProperty(t);
    }, K.prototype.__iterate = function(t, e) {
      for (var r = this._object,
          n = this._keys,
          i = n.length - 1,
          o = 0; i >= o; o++) {
        var u = n[e ? i - o : o];
    ...
    }, K.prototype[cr] = !0, t(R, k), R.prototype.__iterateUncached = function(t, e) {
      if (e)
      ...
      var r = this._iterable,
          ...
          i = 0;
      if (q(n))
        for (var o = void 0; !(o = n.next()).done && t(o.value, i++, this) !== !1; )
          ;
      return i;
    ...
    var Ur = 16,
        ...
        Tr = 0,
        Wr = {};
    t(ct, et), ct.prototype.toString = function() {
    ...
    var Br = "@@__IMMUTABLE_MAP__@@",
        Cr = ct.prototype;
    Cr[Br] = !0, Cr[_r] = Cr.remove, Cr.removeIn = Cr.deleteIn, pt.prototype.get = function(t, e, r, n) {
      ...
      if (!f && v && _.length >= Pr)
        return Ot(t, _, h, s, v);
      if (f && !v && 2 === _.length && qt(_[1 ^ c]))
        return _[1 ^ c];
      if (f && v && 1 === _.length && qt(v))
        return v;
      var l = t && t === this.ownerID,
          y = f ? v ? h : h ^ a : h | a,
          d = f ? v ? Ut(_, c, v, l) : Tt(_, c, l) : Lt(_, c, v, l);
      ...
      var s = i === yr;
      if (r !== this.keyHash)
        return s ? this : (c(u), c(o), Dt(this, t, e, r, [n, i]));
      for (var a = this.entries,
          h = 0,
          f = a.length; f > h && !X(n, a[h][0]); h++)
        ;
      var _ = f > h;
      ...
      for (var t = this._type,
        ...
        if (n.entry) {
          ...
          if (r = n.entries.length - 1, r >= i)
            return gt(t, n.entries[this._reverse ? r - i : i]);
    ...
    t(Wt, rt), Wt.of = function() {
      ...
      for (var r = void 0,
          n = 0,
          i = Jt(this, e); (r = i()) !== Xr && t(r, n++, this) !== !1; )
        ;
      return n;
    ...
    t(ne, x), ne.prototype.get = function(t, e) {
      ...
      return this.__toString(Ke(this) + " {", "}");
      ...
      if (!this.has(t))
        throw Error('Cannot set unknown key "' + t + '" on ' + Ke(this));
    ...
    var Zr = "@@__IMMUTABLE_SET__@@",
        $r = Le.prototype;
    $r[Zr] = !0, $r[_r] = $r.remove, $r.mergeDeep = $r.merge, $r.mergeDeepWith = $r.mergeWith, $r.withMutations = Cr.withMutations, $r.asMutable = Cr.asMutable, $r.asImmutable = Cr.asImmutable, $r.__empty = Ce, $r.__make = Be;
    var tn;
    ...
    t(Ve, rt), Ve.of = function() {
      ...
      for (var r = 0,
          n = this._head; n && t(n.value, r++, this) !== !1; )
        n = n.next;
      return r;
    ...
    e.Iterator = S, Fe(e, {
      ...
      toList: function() {
        return Wt(u(this) ? this.valueSeq() : this);
      },
      toString: function() {
        return "[Iterable]";
      },
    ...
    sn[ar] = !0, sn[br] = sn.values, sn.__toJS = sn.toArray, sn.__toStringMapper = er, sn.inspect = sn.toSource = function() {
      return "" + this;
    }, sn.chain = sn.flatMap, sn.contains = sn.includes, function() {
      try {
        Object.defineProperty(sn, "length", {get: function() {
    ...
    }), i.prototype.has = sn.includes, Fe(x, r.prototype), Fe(k, n.prototype), Fe(A, i.prototype), Fe(et, r.prototype), Fe(rt, n.prototype), Fe(nt, i.prototype);
    var hn = {
      Iterable: e,
      Seq: O,
      Collection: tt,
...
System.get("../../../../node_modules/immutable/dist/immutable.min.js" + '');
