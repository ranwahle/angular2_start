System.registerModule("../../../../node_modules/json3/lib/json3.min.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/json3/lib/json3.min.js";
  ;
  (function() {
    var n = null;
    (function(G) {
      ...
      if (!m("json")) {
        ...
        x = function(a, c) {
          ...
          if (e)
            x = e == 2 ? function(a, c) {
              var e = {},
                  b = p.call(a) == "[object Function]",
                  f;
              for (f in a)
                !(b && f == "prototype") && !q.call(e, f) && (e[f] = 1) && q.call(a, f) && c(f);
            } : function(a, c) {
              var e = p.call(a) == "[object Function]",
                  b,
                  f;
              for (b in a)
          ...
          o.stringify = function(a, c, b) {
            ...
            if (typeof c == "function" || typeof c == "object" && c)
              if ((d = p.call(c)) == "[object Function]")
                ...
                for (var h = 0,
                    k = c.length,
                    i = void 0; h < k; i = c[h++], (d = p.call(i), d == "[object String]" || d == "[object Number]") && (j[i] = 1))
                  ;
              }
            if (b)
...
System.get("../../../../node_modules/json3/lib/json3.min.js" + '');
