System.registerModule("../../../../node_modules/connect-history-api-fallback/test/index_test.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/connect-history-api-fallback/test/index_test.js";
  ...
  tests['should work in verbose mode'] = function(test) {
    var expected = req.url = 'js/app.js';
    middleware = historyApiFallback({verbose: true});
    middleware(req, null, next);
    test.equal(req.url, expected);
    test.ok(next.called);
    test.done();
  ...
  tests['should work with a custom logger'] = function(test) {
    ...
    middleware = historyApiFallback({logger: logger});
    middleware(req, null, next);
    test.equal(req.url, expected);
    test.ok(next.called);
  ...
  tests['should rewrite requested path according to rules'] = function(test) {
    req.url = '/soccer';
    middleware = historyApiFallback({rewrites: [{
        from: /\/soccer/,
        to: '/soccer.html'
      }]});
    middleware(req, null, next);
  ...
  tests['should support custom index file'] = function(test) {
    ...
    req.url = '/socer';
    middleware = historyApiFallback({index: index});
    middleware(req, null, next);
...
System.get("../../../../node_modules/connect-history-api-fallback/test/index_test.js" + '');
