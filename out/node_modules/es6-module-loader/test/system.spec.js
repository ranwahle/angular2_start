System.registerModule("../../../../node_modules/es6-module-loader/test/system.spec.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/es6-module-loader/test/system.spec.js";
  ...
  describe('System', function() {
    ...
    describe('#import', function() {
      describe('an ES5 script', function() {
        it('should import a ES5 script', function(done) {
          System.import('test/syntax/script.js').then(function(m) {
            expect(!!m).to.be.ok();
          }).then(done, done);
        });
        it('should import a ES5 script once loaded', function(done) {
          System.import('test/syntax/script.js').then(function() {
            return System.import('test/syntax/script.js').then(function(m) {
              expect(!!m).to.be.ok();
            });
          }).then(done, done);
        });
      ...
      describe('with circular dependencies', function() {
        (System.transpiler == 'traceur' ? it : it.skip)('should resolve circular dependencies', function(done) {
          System.import('test/syntax/circular1.js').then(function(m1) {
        ...
        it('should update circular dependencies', function(done) {
          System.import('test/syntax/even.js').then(function(m) {
      ...
      describe('errors', function() {
        ...
        it('should throw if on syntax error', function(done) {
          System.import('test/loads/main.js').then(supposedToFail).catch(function(e) {
            expect(e).to.be.equal('dep error\n\tError evaluating ' + baseURL + 'test/loads/deperror.js');
          }).then(done, done);
        });
        it('should throw what the script throws', function(done) {
          System.import('test/loads/deperror.js').then(supposedToFail).catch(function(e) {
            expect(e == 'dep error');
          }).then(done, done);
        });
        it('Unhandled rejection test', function(done) {
          System.import('test/loads/load-non-existent.js').then(supposedToFail).catch(function(e) {
      ...
      describe('es6 export syntax overview', function() {
        it('should resolve different export syntax', function(done) {
          System.import('test/syntax/export.js').then(function(m) {
      ...
      describe('es6 export default syntax', function() {
        it('should resolve "export default"', function(done) {
          System.import('test/syntax/export-default.js').then(function(m) {
      ...
      describe('es6 export re-exporting', function() {
        it('should support simple re-exporting', function(done) {
          System.import('test/syntax/reexport1.js').then(function(m) {
            expect(m.p, 'should export 5 from the "./export"').to.be.equal(5);
          }).then(done, done);
        });
        it('should support re-exporting binding', function(done) {
          System.import('test/syntax/reexport-binding.js').then(function() {
        ...
        it('should support re-exporting with a new name', function(done) {
          System.import('test/syntax/reexport2.js').then(function(m) {
        ...
        it('should support re-exporting', function(done) {
          System.import('test/syntax/export-star.js').then(function(m) {
        ...
        (System.transpiler != 'traceur' ? it.skip : it)('should support re-exporting overwriting', function(done) {
          System.import('test/syntax/export-star2.js').then(function(m) {
            expect(m.bar, 'should re-export "./export-star" bar variable').to.be.equal('bar');
      ...
      describe('es6 import syntax overview', function() {
        it('should resolve different import syntax', function(done) {
          System.import('test/syntax/import.js').then(function(m) {
      ...
      describe('a script with metas', function() {
        it('should support module name meta', function(done) {
          System.import('test/loader/moduleName.js').then(function(m) {
    ...
    describeIf(typeof window != 'undefined' && window.Worker, 'with Web Worker', function() {
    ...
    describeIf(typeof window != 'undefined', 'with script type "module"', function() {
...
System.get("../../../../node_modules/es6-module-loader/test/system.spec.js" + '');
