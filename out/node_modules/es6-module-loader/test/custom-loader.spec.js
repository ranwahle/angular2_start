System.registerModule("../../../../node_modules/es6-module-loader/test/custom-loader.spec.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/es6-module-loader/test/custom-loader.spec.js";
    ...
    describe('#import', function() {
      describe('scripts', function() {
        if (typeof __karma__ == 'undefined' || !__karma__.config.system.ie8)
          it('should support ES6 scripts', function(done) {
            customLoader['import']('test/loader/test.js').then(function(m) {
              expect(m.loader).to.be.equal('custom');
            }).then(done, done);
          });
        it('should support AMD scripts', function(done) {
          customLoader['import']('test/loader/amd.js').then(function(m) {
      ...
      describe('special #locate path rule', function a() {
        if (typeof __karma__ == 'undefined' || !__karma__.config.system.ie8)
          it('should support special loading rules', function(done) {
            customLoader['import']('path/custom.js').then(function(m) {
      ...
      describe('errors', function() {
        ...
        it('should make the normalize throw', function(done) {
          customLoader['import']('test/loader/error1-parent.js').then(supposeToFail, function(e) {
            expect(e.toString()).to.contain('Error loading ' + base + 'error1-parent.js');
          }).then(done, done);
        });
        it('should make the locate throw', function(done) {
          customLoader['import']('test/loader/error2').then(supposeToFail, function(e) {
        ...
        it('should make the fetch throw', function(done) {
          customLoader['import']('test/loader/error3').then(supposeToFail, function(e) {
        ...
        it('should make the translate throw', function(done) {
          customLoader['import']('test/loader/error4').then(supposeToFail, function(e) {
        ...
        it('should make the instantiate throw', function(done) {
          customLoader['import']('test/loader/error5').then(supposeToFail, function(e) {
...
System.get("../../../../node_modules/es6-module-loader/test/custom-loader.spec.js" + '');
