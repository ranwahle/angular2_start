System.registerModule("../../../../node_modules/es6-module-loader/dist/es6-module-loader-dev.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/es6-module-loader/dist/es6-module-loader-dev.js";
  !function(a) {
    function b(a, c) {
      if ("string" != typeof a)
    ...
    k(d.prototype, "toString", {value: function() {
      ...
      e.prototype = {
        ...
        load: function(a, b) {
          var c = this._loader;
          return c.modules[a] ? (D(c.modules[a], [], c), Promise.resolve(c.modules[a].module)) : c.importPromises[a] || w(this, a, g(c, a, {}).then(function(b) {
            return delete c.importPromises[a], C(c, b);
          }));
        },
        module: function(a, b) {
          var c = f();
    ...
    f.prototype.normalize = function(a, b, c) {
      return a = a.match(r) || "." == a[0] ? new o(a, b || m).href : new o(g(this.paths, a), m).href;
...
System.get("../../../../node_modules/es6-module-loader/dist/es6-module-loader-dev.js" + '');
