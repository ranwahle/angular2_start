System.registerModule("../../../../node_modules/es6-module-loader/dist/es6-module-loader.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/es6-module-loader/dist/es6-module-loader.js";
  !function(a) {
    function b(a, c) {
      if ("string" != typeof a)
      ...
      if (void 0 !== c) {
        var n = c instanceof b ? c : new b(c),
            o = "" === e && "" === h && "" === f;
        o && "" === k && "" === l && (l = n.search), o && "/" !== k.charAt(0) && (k = "" !== k ? ("" === n.host && "" === n.username || "" !== n.pathname ? "" : "/") + n.pathname.slice(0, n.pathname.lastIndexOf("/") + 1) + k : n.pathname);
        var p = [];
        k.replace(/^(\.\.?(\/|$))+/, "").replace(/\/(\.(\/|$))+/g, "/").replace(/\/\.\.$/, "/../").replace(/\/?[^\/]*/g, function(a) {
          "/.." === a ? p.pop() : p.push(a);
        }), k = p.join("").replace(/^\//, "/" === k.charAt(0) ? "/" : ""), o && (j = n.port, i = n.hostname, h = n.host, g = n.password, f = n.username), "" === e && (e = n.protocol);
      }
      "file:" == e && (k = k.replace(/\\/g, "/")), this.origin = e + ("" !== e || "" !== h ? "//" : "") + h, this.href = e + ("" !== e || "" !== h ? "//" : "") + ("" !== f ? f + ("" !== g ? ":" + g : "") + "@" : "") + h + k + l + m, this.protocol = e, this.username = f, this.password = g, this.host = h, this.hostname = i, this.port = j, this.pathname = k, this.search = l, this.hash = m;
    }
    a.URLPolyfill = b;
    ...
    function b(a, b) {
      ...
      if (a instanceof Error) {
        var c = new Error(a.message, a.fileName, a.lineNumber);
        i ? (c.message = a.message + "\n	" + b, c.stack = a.stack) : (c.message = a.message, c.stack = a.stack + "\n	" + b);
      } else
        c = a + "\n	" + b;
      return c;
    }
    ...
    k(d.prototype, "toString", {value: function() {
      ...
      function m(b, d, e) {
        e.then(function(e) {
          return "loading" == d.status ? Promise.resolve(b.loaderObj.translate({
            ...
            if (void 0 === e)
              return d.address = d.address || "<Anonymous Module " + ++A + ">", d.isDeclarative = !0, z.call(b.loaderObj, d).then(function(b) {
                var e = a.System,
                    f = e.register;
          ...
          if (a.loader.loaderObj.execute === !1) {
            for (var d = [].concat(a.loads),
              ...
              b.module = b.isDeclarative ? {
                ...
                module: B({}),
                evaluated: !0
              } : {module: B({})}, b.status = "linked", t(a.loader, b);
            }
            return a.resolve(c);
          }
          var g = q(a);
        ...
        if (a.loads.length)
          for (var d = a.loads.concat([]),
            ...
            f.module = {
              name: f.name,
              module: g
            }, f.status = "linked", t(c, f);
          }
      }
      function x(a, b) {
        return b.module.module;
      }
      function y() {}
      function z() {
      ...
      e.prototype = {
        ...
        get: function(a) {
          return this._loader.modules[a] ? (y(this._loader.modules[a], [], this), this._loader.modules[a].module) : void 0;
        },
        has: function(a) {
        ...
        "import": function(a, b, c) {
          ...
          return Promise.resolve(d.normalize(a, b)).then(function(a) {
            var b = d._loader;
            return b.modules[a] ? (y(b.modules[a], [], b._loader), b.modules[a].module) : b.importPromises[a] || v(d, a, g(b, a, {}).then(function(c) {
              return delete b.importPromises[a], x(b, c);
            }));
          });
        },
        load: function(a, b) {
          var c = this._loader;
          return c.modules[a] ? (y(c.modules[a], [], c), Promise.resolve(c.modules[a].module)) : c.importPromises[a] || v(this, a, g(c, a, {}).then(function(b) {
            return delete c.importPromises[a], x(c, b);
          }));
        },
        module: function(a, b) {
          var c = f();
      ...
      var B = e.prototype.newModule;
    }();
    var p;
    h.prototype = e.prototype, f.prototype = new h;
    var q = /^([^\/]+:\/\/|\/)/;
    f.prototype.normalize = function(a, b, c) {
      return a = a.match(q) || "." == a[0] ? new o(a, b || m).href : new o(g(this.paths, a), m).href;
    ...
    if ("undefined" != typeof XMLHttpRequest)
      ...
      r = function(a, b, c, d) {
        ...
        return s = s || require("fs"), a = j ? a.replace(/\//g, "\\").substr(8) : a.substr(7), s.readFile(a, function(a, b) {
          if (a)
            return d(a);
          var e = b + "";
...
System.get("../../../../node_modules/es6-module-loader/dist/es6-module-loader.js" + '');
