System.registerModule("../../../../node_modules/browser-sync-ui/lib/client-js.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/browser-sync-ui/lib/client-js.js";
  (function(window, document, bs, undefined) {
    var socket = bs.socket;
    var uiOptions = {bs: {}};
    socket.on("ui:connection", function(options) {
      uiOptions = options;
      bs.socket.emit("ui:history:connected", {href: window.location.href});
    });
...
System.get("../../../../node_modules/browser-sync-ui/lib/client-js.js" + '');
