System.registerModule("../../../../node_modules/browser-sync-ui/lib/directive-stripper.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/browser-sync-ui/lib/directive-stripper.js";
  ...
  function directiveStripper(config, item, markup, done) {
    ...
    var chunks = [];
    new vinyl({contents: new Buffer(markup)}).pipe(tokenize()).pipe(replacer).pipe(through2.obj(function(row, buf, next) {
      chunks.push(row[1]);
      next();
    }, function() {
...
System.get("../../../../node_modules/browser-sync-ui/lib/directive-stripper.js" + '');
