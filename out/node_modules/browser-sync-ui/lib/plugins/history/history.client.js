System.registerModule("../../../../../../node_modules/browser-sync-ui/lib/plugins/history/history.client.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/browser-sync-ui/lib/plugins/history/history.client.js";
  (function(angular) {
    var SECTION_NAME = "history";
    angular.module("BrowserSync").controller("HistoryController", ["$scope", "options", "History", "pagesConfig", historyController]);
    ...
    angular.module("BrowserSync").directive("historyList", function() {
      return {
        restrict: "E",
        scope: {
          options: "=",
...
System.get("../../../../../../node_modules/browser-sync-ui/lib/plugins/history/history.client.js" + '');
