System.registerModule("../../../../../../../node_modules/browser-sync-ui/lib/plugins/remote-debug/overlay-grid/overlay-grid.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../../node_modules/browser-sync-ui/lib/plugins/remote-debug/overlay-grid/overlay-grid.js";
  ...
  module.exports.init = function(ui) {
    var TRANSMIT_EVENT = "ui:remote-debug:css-overlay-grid";
    var READY_EVENT = "ui:remote-debug:css-overlay-grid:ready";
    var OPT_PATH = ["remote-debug", "overlay-grid"];
    var defaults = {
      offsetY: "0",
      offsetX: "0",
      size: "16px",
    ...
    ui.clients.on("connection", function(client) {
      client.on(READY_EVENT, function() {
        client.emit(TRANSMIT_EVENT, {innerHTML: getCss(ui.options.getIn(OPT_PATH).toJS())});
      });
    });
    ...
    var methods = {
      ...
      adjust: function(data) {
        ...
        ui.clients.emit(TRANSMIT_EVENT, {innerHTML: getCss(ui.options.getIn(OPT_PATH).toJS())});
      },
...
System.get("../../../../../../../node_modules/browser-sync-ui/lib/plugins/remote-debug/overlay-grid/overlay-grid.js" + '');
