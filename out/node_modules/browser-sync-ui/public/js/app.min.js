System.registerModule("../../../../../node_modules/browser-sync-ui/public/js/app.min.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/browser-sync-ui/public/js/app.min.js";
  (function(modules) {
    ...
    angular.module("BrowserSync", ["bsHistory", "bsClients", "bsDisconnect", "bsNotify", "bsSocket", "bsStore", "ngRoute", "ngTouch", "ngSanitize"]).config(["$locationProvider", Config]);
    ...
    (function(window, document, undefined) {
      ...
      function minErr(module, ErrorConstructor) {
        ...
        return function() {
          ...
          message += "\nhttp://errors.angularjs.org/1.4.5/" + (module ? module + "/" : "") + code;
        ...
        if (jQuery && jQuery.fn.on) {
          ...
          jQuery.cleanData = function(elems) {
            ...
            if (!skipDestroyOnNextJQueryCleanData) {
              for (var i = 0,
                  elem = void 0; (elem = elems[i]) != null; i++) {
    ...
    (function() {
      ...
      function disconnectController($scope, $rootScope, $window) {
        ...
        var DEFAULT_MESSAGE = "Disconnected";
    ...
    (function(angular) {
      angular.module("bsHistory", ["bsSocket"]).service("History", ["Socket", HistoryService]);
    ...
    (function(angular, browserSyncSocket) {
      ...
      function SocketService($q, $rootScope) {
        ...
        Object.defineProperty(publicApi, "sessionId", {get: function() {
            return session;
          }});
        return publicApi;
      }
      ...
      (function(win) {
        ...
        if (isLocalStorageNameSupported()) {
          ...
          store.clear = withIEStorage(function(storage) {
            ...
            storage.load(localStorageName);
            for (var i = 0,
                attr = void 0; attr = attributes[i]; i++) {
        ...
        if (typeof module != "undefined" && module.exports && this.module !== module) {
          ...
          !(__WEBPACK_AMD_DEFINE_FACTORY__ = store, __WEBPACK_AMD_DEFINE_RESULT__ = typeof __WEBPACK_AMD_DEFINE_FACTORY__ === "function" ? __WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module) : __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
        } else {
          win.store = store;
        }
      })(Function("return this")());
    }).call(exports, __webpack_require__(20)(module));
  }, function(module, exports) {
    ...
    module.filter("ucfirst", function() {
      ...
      return utils.localRootUrl;
    }).filter("localUrl", function() {
      return utils.localRootUrl;
    }).filter("orderObjectBy", function() {
      return utils.orderObjectBy;
    });
  }, function(module, exports) {
    module.exports = {
    ...
    var module = __webpack_require__(15);
    module.directive("icon", __webpack_require__(26));
    module.directive("linkTo", __webpack_require__(27));
    module.directive("switch", __webpack_require__(28));
    module.directive("newTab", __webpack_require__(29));
  }, function(module, exports) {
...
System.get("../../../../../node_modules/browser-sync-ui/public/js/app.min.js" + '');
