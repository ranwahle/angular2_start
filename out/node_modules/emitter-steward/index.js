System.registerModule("../../../node_modules/emitter-steward/index.js", [], function() {
  "use strict";
  var __moduleName = "../../../node_modules/emitter-steward/index.js";
  var EmitterSteward = function(emitter) {
    this.currentEmitter = null;
    this.counter = 0;
    this.debug = function(msg, vars) {
      emitter.emit("msg:debug", {
        msg: msg,
        vars: vars
      });
    };
...
System.get("../../../node_modules/emitter-steward/index.js" + '');
