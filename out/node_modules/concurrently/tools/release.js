System.registerModule("../../../../node_modules/concurrently/tools/release.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/concurrently/tools/release.js";
  var fs = require('fs');
  ...
  function main() {
    ...
    _gitBranchName().then(function(stdout) {
      ...
      var message = Mustache.render(config.releaseMessage, {version: newVersion});
      return gitCommit(message);
    }).then(function() {
      return gitTag(newVersion);
    }).then(function() {
      return gitPushTag(newVersion);
    }).then(npmPublish).then(function() {
  ...
  function bumpVersion(files, bumpType) {
    ...
    if (config.dryRun)
      return '[not available in dry run]';
    var newVersion;
    var originalVersion;
    files.forEach(function(fileName) {
      ...
      if (!semver.valid(currentVersion)) {
        var msg = 'Invalid version ' + currentVersion + ' in file ' + fileName;
      ...
      status('Bump', originalVersion, '->', newVersion, 'in', fileName);
    });
...
System.get("../../../../node_modules/concurrently/tools/release.js" + '');
