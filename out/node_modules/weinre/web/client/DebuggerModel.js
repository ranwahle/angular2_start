System.registerModule("../../../../../node_modules/weinre/web/client/DebuggerModel.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/DebuggerModel.js";
  ...
  WebInspector.DebuggerModel.prototype = {
    enableDebugger: function() {
      ...
      for (var i = 0; i < breakpoints.length; ++i) {
        ...
        if (typeof breakpoint.url !== "string" || typeof breakpoint.lineNumber !== "number" || typeof breakpoint.columnNumber !== "number" || typeof breakpoint.condition !== "string" || typeof breakpoint.enabled !== "boolean")
          continue;
    ...
    scriptsForURL: function(url) {
      return this.queryScripts(function(s) {
    ...
    _updateScriptSource: function(sourceID, scriptSource) {
      ...
      this.dispatchEventToListeners(WebInspector.DebuggerModel.Events.ScriptSourceChanged, {
        sourceID: sourceID,
        oldSource: oldSource
      });
    },
...
System.get("../../../../../node_modules/weinre/web/client/DebuggerModel.js" + '');
