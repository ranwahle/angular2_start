System.registerModule("../../../../../node_modules/weinre/web/client/CookiesTable.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/CookiesTable.js";
  ...
  WebInspector.CookiesTable.prototype = {
    ...
    _sortCookies: function(cookies) {
      ...
      switch (parseInt(this._dataGrid.sortColumnIdentifier)) {
        case 0:
          ...
          break;
        case 1:
          comparator = localeCompare.bind(this, "value");
          break;
        case 2:
          comparator = localeCompare.bind(this, "domain");
          break;
        case 3:
          comparator = localeCompare.bind(this, "path");
          break;
        case 4:
        ...
        case 5:
          ...
          break;
        case 6:
          comparator = localeCompare.bind(this, "httpOnly");
          break;
        case 7:
          comparator = localeCompare.bind(this, "secure");
          break;
        default:
          localeCompare.bind(this, "name");
      }
    ...
    _createGridNode: function(cookie) {
      ...
      data[3] = cookie.path || "";
      data[4] = cookie.type === WebInspector.Cookie.Type.Request ? "" : (cookie.session ? WebInspector.UIString("Session") : new Date(cookie.expires).toGMTString());
      data[5] = cookie.size;
      var checkmark = "\u2713";
...
System.get("../../../../../node_modules/weinre/web/client/CookiesTable.js" + '');
