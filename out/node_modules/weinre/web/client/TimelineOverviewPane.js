System.registerModule("../../../../../node_modules/weinre/web/client/TimelineOverviewPane.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/TimelineOverviewPane.js";
    ...
    _dragWindow: function(event) {
      ...
      while (node) {
        if (node === this._overviewGrid._dividersLabelBarElement) {
          WebInspector.elementDragStart(this._overviewWindowElement, this._windowDragging.bind(this, event.pageX, this._leftResizeElement.offsetLeft, this._rightResizeElement.offsetLeft), this._endWindowDragging.bind(this), event, "ew-resize");
          break;
...
System.get("../../../../../node_modules/weinre/web/client/TimelineOverviewPane.js" + '');
