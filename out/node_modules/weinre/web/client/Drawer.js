System.registerModule("../../../../../node_modules/weinre/web/client/Drawer.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/Drawer.js";
  ...
  WebInspector.Drawer.prototype = {
    ...
    show: function() {
      ...
      var animations = [{
        ...
        element: this._mainStatusBar,
        start: {"padding-left": anchoredItems.offsetWidth - 1},
        end: {"padding-left": 0}
      }, {
      ...
      if (this._currentPanelCounters) {
        ...
        animations.push({
          element: this._currentPanelCounters,
          start: {"padding-right": rightPadding},
          end: {"padding-right": 0}
        });
    ...
    hide: function() {
      ...
      var animations = [{
        ...
        end: {"padding-left": anchoredItems.offsetWidth - 1}
      }, {
        element: this._viewStatusBar,
        start: {opacity: 1},
        end: {opacity: 0}
      ...
      if (this._currentPanelCounters) {
        ...
        animations.push({
          element: this._currentPanelCounters,
          start: {"padding-right": 0},
          end: {"padding-right": rightPadding}
        });
      }
      function animationFinished() {
...
System.get("../../../../../node_modules/weinre/web/client/Drawer.js" + '');
