System.registerModule("../../../../../node_modules/weinre/web/client/CSSStyleModel.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/CSSStyleModel.js";
      ...
      function callback(userCallback, payload) {
        ...
        for (var i = 0; i < payload.pseudoElements.length; ++i) {
          ...
          result.pseudoElements.push({
            ...
            rules: WebInspector.CSSStyleModel.parseRuleArrayPayload(entryPayload.rules)
          });
        }
        result.inherited = [];
  ...
  WebInspector.CSSProperty.parsePayload = function(ownerStyle, index, payload) {
    var result = new WebInspector.CSSProperty(ownerStyle, index, payload.name, payload.value, payload.priority, payload.status, payload.parsedOk, payload.implicit, payload.shorthandName, payload.text);
    return result;
  };
...
System.get("../../../../../node_modules/weinre/web/client/CSSStyleModel.js" + '');
