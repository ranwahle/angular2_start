System.registerModule("../../../../../node_modules/weinre/web/client/ApplicationCacheItemsView.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/ApplicationCacheItemsView.js";
  ...
  WebInspector.ApplicationCacheItemsView.prototype = {
    get statusBarItems() {
      if (Preferences.onlineDetectionEnabled) {
        return [this.refreshButton.element, this.deleteButton.element, this.connectivityIcon, this.connectivityMessage, this.divider, this.statusIcon, this.statusMessage];
      } else {
        return [this.refreshButton.element, this.deleteButton.element, this.divider, this.statusIcon, this.statusMessage];
      }
    },
...
System.get("../../../../../node_modules/weinre/web/client/ApplicationCacheItemsView.js" + '');
