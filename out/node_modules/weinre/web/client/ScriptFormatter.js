System.registerModule("../../../../../node_modules/weinre/web/client/ScriptFormatter.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/ScriptFormatter.js";
  ...
  WebInspector.ScriptFormatter.findScriptRanges = function(lineEndings, scripts) {
    ...
    for (var i = 0; i < scripts.length; ++i) {
      ...
      scriptRanges.push({
        ...
        sourceID: scripts[i].sourceID
      });
    }
    scriptRanges.sort(function(x, y) {
      return x.start.position - y.start.position;
    });
    return scriptRanges;
  };
...
System.get("../../../../../node_modules/weinre/web/client/ScriptFormatter.js" + '');
