System.registerModule("../../../../../node_modules/weinre/web/client/ConsoleView.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/ConsoleView.js";
  ...
  WebInspector.ConsoleView.prototype = {
    _registerConsoleDomainDispatcher: function() {
      ...
      var dispatcher = {
        addConsoleMessage: function(payload) {
          var consoleMessage = new WebInspector.ConsoleMessage(payload.source, payload.type, payload.level, payload.line, payload.url, payload.repeatCount, payload.message, payload.parameters, payload.stackTrace, payload.requestId);
    ...
    _registerShortcuts: function() {
      ...
      keys = [shortcut.shortcutToString(shortcut.Keys.Tab), shortcut.shortcutToString(shortcut.Keys.Tab, shortcut.Modifiers.Shift)];
      ...
      keys = [shortcut.shortcutToString(shortcut.Keys.Down), shortcut.shortcutToString(shortcut.Keys.Up)];
      section.addRelatedKeys(keys, WebInspector.UIString("Next/previous line"));
      keys = [shortcut.shortcutToString("N", shortcut.Modifiers.Alt), shortcut.shortcutToString("P", shortcut.Modifiers.Alt)];
    ...
    isEqual: function(msg) {
      ...
      if (this._stackTrace) {
        ...
        for (var i = 0; i < l.length; i++) {
          if (l[i].scriptName !== r[i].scriptName || l[i].functionName !== r[i].functionName || l[i].lineNumber !== r[i].lineNumber || l[i].column !== r[i].column)
            return false;
        }
      }
      return (this.source === msg.source) && (this.type === msg.type) && (this.level === msg.level) && (this.line === msg.line) && (this.url === msg.url) && (this.message === msg.message) && (this._requestId === msg._requestId);
    }
  };
  ...
  WebInspector.ConsoleCommand.prototype = {toMessageElement: function() {
      var element = document.createElement("div");
  ...
  WebInspector.ConsoleCommandResult.prototype = {toMessageElement: function() {
...
System.get("../../../../../node_modules/weinre/web/client/ConsoleView.js" + '');
