System.registerModule("../../../../../node_modules/weinre/web/client/Resource.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/Resource.js";
  ...
  WebInspector.Resource.prototype = {
    ...
    get sortedRequestHeaders() {
      ...
      for (var key in this.requestHeaders)
        this._sortedRequestHeaders.push({
          header: key,
          value: this.requestHeaders[key]
        });
      this._sortedRequestHeaders.sort(function(a, b) {
    ...
    get sortedResponseHeaders() {
      ...
      for (var key in this.responseHeaders)
        this._sortedResponseHeaders.push({
          header: key,
    ...
    _mimeTypeIsConsistentWithType: function() {
      if (this.statusCode >= 400)
        return true;
      if (typeof this.type === "undefined" || this.type === WebInspector.Resource.Type.Other || this.type === WebInspector.Resource.Type.XHR || this.type === WebInspector.Resource.Type.WebSocket)
        return true;
      if (!this.mimeType)
        return true;
      ...
      switch (warning.id) {
        case WebInspector.Warnings.IncorrectMIMEType.id:
          if (!this._mimeTypeIsConsistentWithType())
            msg = new WebInspector.ConsoleMessage(WebInspector.ConsoleMessage.MessageSource.Other, WebInspector.ConsoleMessage.MessageType.Log, WebInspector.ConsoleMessage.MessageLevel.Warning, -1, this.url, 1, String.sprintf(WebInspector.Warnings.IncorrectMIMEType.message, WebInspector.Resource.Type.toUIString(this.type), this.mimeType), null, null);
          break;
      }
      if (msg)
...
System.get("../../../../../node_modules/weinre/web/client/Resource.js" + '');
