System.registerModule("../../../../../node_modules/weinre/web/client/ElementsTreeOutline.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/ElementsTreeOutline.js";
  ...
  WebInspector.ElementsTreeElement.prototype = {
      ...
      function updateChildrenOfNode(node) {
        ...
        while (child) {
          ...
          if (!currentTreeElement || currentTreeElement.representedObject !== child) {
            ...
            for (var i = (treeChildIndex + 1),
                size = treeElement.expandedChildCount; i < size; ++i) {
    ...
    adjustCollapsedRange: function() {
      ...
      for (var i = this.expandedChildCount,
          limit = Math.min(this.expandedChildrenLimit, childNodeCount); i < limit; ++i)
    ...
    _populateTagContextMenu: function(contextMenu, event) {
      ...
      if (Preferences.nativeInstrumentationEnabled) {
        var handlerFunction = function(nodeId, breakType) {
    ...
    _triggerEditAttribute: function(attributeName) {
      ...
      for (var i = 0,
          len = attributeElements.length; i < len; ++i) {
...
System.get("../../../../../node_modules/weinre/web/client/ElementsTreeOutline.js" + '');
