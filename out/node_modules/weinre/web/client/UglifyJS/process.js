System.registerModule("../../../../../../node_modules/weinre/web/client/UglifyJS/process.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/weinre/web/client/UglifyJS/process.js";
  ...
  function ast_add_scope(ast) {
    ...
    return with_new_scope(function() {
      var ret = w.with_walkers({
        ...
        "try": function(t, c, f) {
          if (c != null)
            return [this[0], MAP(t, walk), [define(c[0]), MAP(c[1], walk)], f != null ? MAP(f, walk) : null];
        },
        "name": function(name) {
          if (name == "eval")
    ...
    function needs_parens(expr) {
      if (expr[0] == "function") {
        ...
        while (p) {
          if (p[0] == "stat")
            return true;
          if ((p[0] == "seq" && p[1] === self) || (p[0] == "call" && p[1] === self) || (p[0] == "binary" && p[2] === self)) {
            self = p;
            p = a.pop();
          } else {
            return false;
      ...
      "object": function(props) {
        ...
        return "{" + newline + with_indent(function() {
          return MAP(props, function(p) {
            ...
            return indent(add_spaces(beautify && beautify.space_colon ? [key, ":", val] : [key + ":", val]));
          }).join("," + newline);
        }) + newline + indent("}");
      },
      "regexp": function(rx, mods) {
...
System.get("../../../../../../node_modules/weinre/web/client/UglifyJS/process.js" + '');
