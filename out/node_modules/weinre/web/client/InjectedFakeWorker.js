System.registerModule("../../../../../node_modules/weinre/web/client/InjectedFakeWorker.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/InjectedFakeWorker.js";
  var InjectedFakeWorker = function(InjectedScriptHost, inspectedWindow, injectedScriptId) {
    ...
    FakeWorker.prototype = {
      ...
      _removeEventListener: function(type, callback, useCapture) {
        ...
        for (var i = 0; i < listeners.length; ++i) {
          if (listeners[i].originalCallback === callback && listeners[i].type === type && listeners[i].useCapture === Boolean(useCapture)) {
    ...
    URL.prototype = {
      ...
      sameOrigin: function(url) {
        ...
        return this.schema === other.schema && this.host === other.host && normalizePort(this.schema, this.port) === normalizePort(other.schema, other.port);
      }
    };
...
System.get("../../../../../node_modules/weinre/web/client/InjectedFakeWorker.js" + '');
