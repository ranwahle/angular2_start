System.registerModule("../../../../../node_modules/weinre/web/client/ResourceHeadersView.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/ResourceHeadersView.js";
  ...
  WebInspector.ResourceHeadersView.prototype = {
    _refreshURL: function() {
      this._urlTreeElement.titleHTML = "<div class=\"header-name\">" + WebInspector.UIString("Request URL") + ":</div>" + "<div class=\"header-value source-code\">" + this._resource.url.escapeHTML() + "</div>";
    },
    ...
    _refreshRequestHeaders: function() {
      ...
      if (typeof this._resource.webSocketRequestKey3 !== "undefined")
        additionalRow = {
          header: "(Key3)",
          value: this._resource.webSocketRequestKey3
        };
    ...
    _refreshResponseHeaders: function() {
      ...
      if (typeof this._resource.webSocketChallengeResponse !== "undefined")
        additionalRow = {
          ...
          value: this._resource.webSocketChallengeResponse
        };
    ...
    _refreshHTTPInformation: function() {
      ...
      if (this._resource.statusCode) {
        ...
        requestMethodElement.titleHTML = "<div class=\"header-name\">" + WebInspector.UIString("Request Method") + ":</div>" + "<div class=\"header-value source-code\">" + this._resource.requestMethod + "</div>";
        statusCodeElement.titleHTML = "<div class=\"header-name\">" + WebInspector.UIString("Status Code") + ":</div>" + statusCodeImage + "<div class=\"header-value source-code\">" + statusTextEscaped + "</div>";
      }
    },
...
System.get("../../../../../node_modules/weinre/web/client/ResourceHeadersView.js" + '');
