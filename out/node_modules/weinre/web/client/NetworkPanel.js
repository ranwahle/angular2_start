System.registerModule("../../../../../node_modules/weinre/web/client/NetworkPanel.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/NetworkPanel.js";
  ...
  WebInspector.NetworkPanel.prototype = {
    ...
    _updateSummaryBar: function() {
      ...
      if (!numRequests) {
        ...
        this._summaryBarElement.appendChild(document.createTextNode(WebInspector.UIString("No requests captured. Reload the page to see detailed information on the network activity.")));
        return;
      }
      ...
      if (baseTime !== -1 && this._mainResourceLoadTime !== -1 && this._mainResourceDOMContentTime !== -1 && this._mainResourceDOMContentTime > baseTime) {
        text += "  \u2758  " + String.sprintf(WebInspector.UIString("%s (onload: %s, DOMContentLoaded: %s)"), Number.secondsToString(maxTime - baseTime), Number.secondsToString(this._mainResourceLoadTime - baseTime), Number.secondsToString(this._mainResourceDOMContentTime - baseTime));
      }
    ...
    _exportAll: function() {
      var harArchive = {log: (new WebInspector.HARLog()).build()};
  ...
  WebInspector.NetworkBaseCalculator.prototype = {
    ...
    computeBarGraphPercentages: function(item) {
      return {
        start: 0,
        middle: 0,
        end: (this._value(item) / this.boundarySpan) * 100
      };
    },
...
System.get("../../../../../node_modules/weinre/web/client/NetworkPanel.js" + '');
