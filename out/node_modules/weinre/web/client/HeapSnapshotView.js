System.registerModule("../../../../../node_modules/weinre/web/client/HeapSnapshotView.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/HeapSnapshotView.js";
  WebInspector.HeapSnapshotView = function(parent, profile) {
    ...
    var columns = {
      ...
      countDelta: {
        title: WebInspector.UIString("\xb1 Count"),
        width: "72px",
        sortable: true
      },
      sizeDelta: {
        title: WebInspector.UIString("\xb1 Size"),
        width: "72px",
        sortable: true
      }
    };
  ...
  WebInspector.HeapSnapshotView.prototype = {
    ...
    performSearch: function(query, finishedCallback) {
      ...
      function matchesQuery(heapSnapshotDataGridNode) {
        ...
        if (heapSnapshotDataGridNode._searchMatchedConsColumn || heapSnapshotDataGridNode._searchMatchedCountColumn || heapSnapshotDataGridNode._searchMatchedSizeColumn || heapSnapshotDataGridNode._searchMatchedCountDeltaColumn || heapSnapshotDataGridNode._searchMatchedSizeDeltaColumn) {
      ...
      for (var iter = rootEdgesIter; iter.hasNext(); iter.next()) {
        ...
        if (node.isHidden)
          ...
          for (var innerIter = node.edges; innerIter.hasNext(); innerIter.next()) {
            ...
            entry[edge.nodeIndex] = {
              constructorName: edge.node.name,
              count: edge.name
            };
          }
    ...
    _prepareProfile: function(profile) {
        ...
        for (var childAddr in retainer) {
          ...
          if ((item.constructorName === "Object" || item.constructorName === "Array")) {
            if (!(itemId in profile.clusters))
              profile.clusters[itemId] = {
                constructorName: itemId,
                retainers: {}
              };
      ...
      function mergeRetainers(entry, item) {
        if (!(retainer.constructorName in entry.retainers))
          entry.retainers[retainer.constructorName] = {
            constructorName: retainer.constructorName,
            count: 0,
            clusters: {}
          };
    ...
    _updateBaseOptions: function() {
      ...
      if (this.baseSelectElement.length === list.length)
        return;
      for (var i = this.baseSelectElement.length,
          n = list.length; i < n; ++i) {
  ...
  WebInspector.HeapSummaryCountCalculator.prototype = {
    _highFromLow: function(type) {
      if (type === "CODE_TYPE" || type === "SHARED_FUNCTION_INFO_TYPE" || type === "SCRIPT_TYPE")
        return "code";
      if (type === "STRING_TYPE" || type === "HEAP_NUMBER_TYPE" || type.match(/^JS_/))
        return "data";
      return null;
    },
  ...
  WebInspector.HeapSnapshotDataGridNodeWithRetainers.prototype = {
    ...
    createCell: function(columnIdentifier) {
      ...
      if ((columnIdentifier === "cons" && this._searchMatchedConsColumn) || (columnIdentifier === "count" && this._searchMatchedCountColumn) || (columnIdentifier === "size" && this._searchMatchedSizeColumn) || (columnIdentifier === "countDelta" && this._searchMatchedCountDeltaColumn) || (columnIdentifier === "sizeDelta" && this._searchMatchedSizeDeltaColumn))
  ...
  WebInspector.HeapSnapshotDataGridNode = function(snapshotView, baseEntry, snapshotEntry, owningTree) {
    ...
    if (!snapshotEntry)
      snapshotEntry = {
        constructorName: baseEntry.constructorName,
        count: 0,
        size: 0,
        retainers: {}
      };
          ...
          if (clusterName in snapshot.clusters) {
            ...
            for (var clusterRetainer in clusterRetainers) {
              ...
              if (!(clusterRetainer in retainers))
                retainers[clusterRetainer] = {
                  constructorName: clusterRetainerEntry.constructorName,
                  count: 0,
                  clusters: {}
                };
...
System.get("../../../../../node_modules/weinre/web/client/HeapSnapshotView.js" + '');
