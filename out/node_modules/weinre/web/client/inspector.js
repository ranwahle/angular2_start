System.registerModule("../../../../../node_modules/weinre/web/client/inspector.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/inspector.js";
  ;
    ...
    set currentPanel(x) {
      ...
      if (x) {
        ...
        if (this.currentQuery) {
          if (x.performSearch) {
            var performPanelSearch = function() {
  ...
  WebInspector.doLoadedDone = function() {
    ...
    this.Tips = {ResourceNotCompressed: {
        id: 0,
        message: WebInspector.UIString("You could save bandwidth by having your web server compress this transfer with gzip or zlib.")
      }};
    this.Warnings = {IncorrectMIMEType: {
        id: 0,
        message: WebInspector.UIString("Resource interpreted as %s but transferred with MIME type %s.")
      }};
  ...
  WebInspector._registerShortcuts = function() {
    ...
    var keys = [shortcut.shortcutToString("]", shortcut.Modifiers.CtrlOrMeta), shortcut.shortcutToString("[", shortcut.Modifiers.CtrlOrMeta)];
    ...
    if (WebInspector.isMac()) {
      keys = [shortcut.shortcutToString("g", shortcut.Modifiers.Meta), shortcut.shortcutToString("g", shortcut.Modifiers.Meta | shortcut.Modifiers.Shift)];
  ...
  WebInspector.documentKeyDown = function(event) {
    ...
    if (key === "F1" || (key === helpKey && event.shiftKey && (!isInEditMode && !isInputElement || event.metaKey))) {
  ...
  WebInspector.log = function(message, messageLevel) {
    ...
    function logMessage(message) {
      ...
      var msg = new WebInspector.ConsoleMessage(WebInspector.ConsoleMessage.MessageSource.Other, WebInspector.ConsoleMessage.MessageType.Log, messageLevel || WebInspector.ConsoleMessage.MessageLevel.Debug, -1, null, repeatCount, null, [message], null);
  ...
  WebInspector.startEditing = function(element, config) {
    ...
    function defaultFinishHandler(event) {
      ...
      if (isEnterKey(event) && (!config.multiline || isMetaOrCtrl))
        ...
        return "cancel";
      else if ((event.keyIdentifier || event.key) === "U+0009")
...
System.get("../../../../../node_modules/weinre/web/client/inspector.js" + '');
