System.registerModule("../../../../../node_modules/weinre/web/client/BreakpointManager.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/BreakpointManager.js";
  ...
  WebInspector.EventListenerBreakpoint.prototype = {
    ...
    _serializeToJSON: function() {
      ...
      return {
        type: type,
        condition: {eventName: this._eventName}
      };
    }
  };
  ...
  WebInspector.DOMBreakpointView.prototype = {
    ...
    populateStatusMessageElement: function(element, eventData) {
      ...
      var formatters = {s: function(substitution) {
          return substitution;
        }};
      function append(a, b) {
        if (typeof b === "string")
...
System.get("../../../../../node_modules/weinre/web/client/BreakpointManager.js" + '');
