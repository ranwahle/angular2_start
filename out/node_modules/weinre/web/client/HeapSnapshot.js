System.registerModule("../../../../../node_modules/weinre/web/client/HeapSnapshot.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/weinre/web/client/HeapSnapshot.js";
  ...
  WebInspector.HeapSnapshot.prototype = {
    ...
    _buildAggregatesIndexes: function() {
      ...
      for (var clss in this._aggregates)
        this._aggregates[clss].idxs.sort(function(idxA, idxB) {
  ...
  WebInspector.HeapSnapshotEdgesProvider.prototype = {sort: function(comparator) {
      ...
      function sortByEdgeFieldName(ascending, indexA, indexB) {
        ...
        if (edgeA.name === "__proto__")
          return 1;
        var result = edgeA.hasStringName === edgeB.hasStringName ? (edgeA.name < edgeB.name ? -1 : (edgeA.name > edgeB.name ? 1 : 0)) : (edgeA.hasStringName ? -1 : 1);
  ...
  WebInspector.HeapSnapshotNodesProvider.prototype = {sort: function(comparator) {
      if (this._lastComparator === comparator)
        return false;
      this._lastComparator = comparator;
      var fieldName1 = comparator.fieldName1;
  ...
  WebInspector.HeapSnapshotPathFinder.prototype = {
    findNext: function() {
      for (var i = 0; i < 100000; ++i) {
        ...
        if (this._isPathFound())
          return {
            path: this._pathToString(this._currentPath),
    ...
    _hasInPath: function(nodeIndex) {
      return this._targetNodeIndex === nodeIndex || !!this._currentPath._cache[nodeIndex];
    },
    _isPathFound: function() {
      return this._currentPath.length === this._maxLength && this._lastEdge.nodeIndex in this._rootChildren;
    },
    get _lastEdgeIter() {
    ...
    _skipEdge: function(edge) {
      return (this._skipHidden && (edge.isHidden || edge.node.isHidden)) || this._hasInPath(edge.nodeIndex);
    },
...
System.get("../../../../../node_modules/weinre/web/client/HeapSnapshot.js" + '');
