System.registerModule("../../../../node_modules/systemjs/test/test.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/systemjs/test/test.js";
  "format global";
  (function(global) {
    ...
    asyncTest('Global script with shim config', function() {
      System.config({meta: {'tests/global-shim-config.js': {deps: ['./global-shim-config-dep.js']}}});
    ...
    asyncTest('Global script loading that detects as AMD with shim config', function() {
      System.config({meta: {'tests/global-shim-amd.js': {format: 'global'}}});
    ...
    asyncTest('Contextual map configuration', function() {
      System.config({
        packages: {'tests/contextual-test': {main: 'contextual-map.js'}},
        map: {'tests/contextual-test': {maptest: '../contextual-map-dep.js'}}
      });
    ...
    asyncTest('Package map with shim', function() {
      System.config({packages: {'tests/shim-package': {
            meta: {'*': {deps: ['shim-map-dep']}},
            map: {'shim-map-dep': '../shim-map-test-dep.js'}
          }}});
    ...
    asyncTest('Loading an AMD module', function() {
      System.config({meta: {'tests/amd-module.js': {format: 'amd'}}});
    ...
    asyncTest('Loading an AMD bundle', function() {
      System.config({bundles: {'tests/amd-bundle.js': ['bundle-1', 'bundle-2']}});
    ...
    asyncTest('CommonJS globals', function() {
      System.config({meta: {'tests/commonjs-globals.js': {globals: {process: './cjs-process.js'}}}});
    ...
    asyncTest('System.register Circular', function() {
      System.config({meta: {'tests/register-circular1.js': {scriptLoad: true}}});
    ...
    asyncTest('System.register group linking test', function() {
      System.config({bundles: {'tests/group-test.js': ['group-a']}});
      System['import']('group-a').then(function(m) {
        ok(m);
        start();
      }, err);
    });
    System.config({bundles: {'tests/mixed-bundle.js': ['tree/third', 'tree/cjs', 'tree/jquery', 'tree/second', 'tree/global', 'tree/amd', 'tree/first']}});
    ...
    asyncTest('Loading System.register from ES6', function() {
      System.config({meta: {'tree/first': {format: 'esm'}}});
    ...
    if (!ie8) {
      ...
      asyncTest('Basic exporting & importing', function() {
        ...
        System['import']('tests/asdf.js').then(function() {}, function(_err) {
          err = _err;
          checkComplete();
        })['catch'](err);
    ...
    asyncTest('Globals', function() {
      System.config({meta: {'tests/with-global-deps.js': {globals: {'$$$': 'tests/dep.js'}}}});
    ...
    asyncTest('Wildcard meta', function() {
      System.config({meta: {
          'tests/cs/main.js': {deps: ['./dep.js']},
          'tests/cs/*': {loader: 'tests/cs-loader.js'}
        }});
    ...
    asyncTest('Package configuration CommonJS config example', function() {
      System.config({
        map: {'global-test': 'tests/testpkg/test.ts'},
        packageConfigPaths: ['tests/testpkg/system.json', 'tests/testpkg/depcache.json'],
        packages: {'tests/testpkg': {
            main: './noext',
            map: {"testpkg": "."},
            asdf: 'asdf'
          }}
      });
      Promise.all([System['import']('tests/testpkg'), System['import']('tests/testpkg/json'), System['import']('tests/testpkg/dir/test'), System['import']('tests/testpkg/dir2'), System['import']('tests/testpkg/dir/'), System['import']('tests/testpkg/env-module'), System['import']('tests/testpkg/self'), System['import']('tests/testpkg/conditional1'), System['import']('tests/testpkg/conditional2'), System['import']('tests/testpkg/self-load.js'), System['import']('tests/testpkg/dir/self-load.js')]).then(function(m) {
        ok(m[0].prop == 'value');
        ok(m[1].prop == 'value');
        ok(m[2] == 'ts');
        ok(m[3].json == 'index');
    ...
    asyncTest('Package edge cases', function() {
      ...
      try {
        clonedSystem.config({packages: {'//': pkgCfg}});
        ok(false);
      } catch (e) {
        ok(e.toString().indexOf('not a valid package name') != -1);
      }
      try {
        clonedSystem.config({packages: {'https://': pkgCfg}});
        ok(false);
      } catch (e) {
        ok(e.toString().indexOf('not a valid package name') != -1);
      }
      clonedSystem.config({packages: {
    ...
    if (!ie8)
      asyncTest('Boolean conditional true', function() {
        System.set('env', System.newModule({'js': {'es5': true}}));
        System.config({paths: {'branch-boolean.js': 'tests/branch-boolean.js'}});
    ...
    asyncTest('Importing a script with wrong integrity fails', function() {
      System.config({meta: {'tests/csp/integrity.js': {
            format: 'amd',
...
System.get("../../../../node_modules/systemjs/test/test.js" + '');
