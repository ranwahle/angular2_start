System.registerModule("../../../../node_modules/systemjs/dist/system-polyfills.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/systemjs/dist/system-polyfills.js";
  !function(t) {
    !function(t) {
      function e(t, n) {
        if ("string" != typeof t)
        ...
        if (void 0 !== n) {
          var l = n instanceof e ? n : new e(n),
              d = "" === r && "" === c && "" === i;
          d && "" === a && "" === h && (h = l.search), d && "/" !== a.charAt(0) && (a = "" !== a ? ("" === l.host && "" === l.username || "" !== l.pathname ? "" : "/") + l.pathname.slice(0, l.pathname.lastIndexOf("/") + 1) + a : l.pathname);
          var y = [];
          a.replace(/^(\.\.?(\/|$))+/, "").replace(/\/(\.(\/|$))+/g, "/").replace(/\/\.\.$/, "/../").replace(/\/?[^\/]*/g, function(t) {
            "/.." === t ? y.pop() : y.push(t);
          }), a = y.join("").replace(/^\//, "/" === a.charAt(0) ? "/" : ""), d && (f = l.port, s = l.hostname, c = l.host, u = l.password, i = l.username), "" === r && (r = l.protocol);
        }
        "file:" == r && (a = a.replace(/\\/g, "/")), this.origin = r + ("" !== r || "" !== c ? "//" : "") + c, this.href = r + ("" !== r || "" !== c ? "//" : "") + ("" !== i ? i + ("" !== u ? ":" + u : "") + "@" : "") + c + a + h + p, this.protocol = r, this.username = i, this.password = u, this.host = c, this.hostname = s, this.port = f, this.pathname = a, this.search = h, this.hash = p;
      }
      t.URLPolyfill = e;
            ...
            t(function() {
              return function(t) {
                ...
                function a(t, n, o) {
                  ...
                  for (var u = void 0,
                      c = "function" == typeof n ? r : i,
                      s = new b,
                      f = o.length >>> 0,
                      a = new Array(f),
                      p = 0; p < o.length && !s.resolved; ++p)
                ...
                e.resolve = o, e.reject = r, e.never = i, e._defer = u, e._handler = v, e.prototype.then = function(t, e, n) {
                  var o = this._handler,
                      r = o.join().state();
                  if ("function" != typeof t && r > 0 || "function" != typeof e && 0 > r)
                    return new this.constructor(j, o);
                  var i = this._beget(),
                      u = i._handler;
                ...
                return O.prototype.run = function() {
                  ...
                  if (void 0 !== t)
                    for (var e = void 0,
                        n = 0; n < t.length; ++n)
                      e = t[n], A(e.progress, this.value, this.handler, e.receiver, e.resolver);
...
System.get("../../../../node_modules/systemjs/dist/system-polyfills.js" + '');
