System.registerModule("../../../../node_modules/systemjs/dist/system-csp-production.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/systemjs/dist/system-csp-production.js";
  !function() {
    function e() {
      !function(e) {
        function t(e, t) {
        ...
        function m(e) {
          ...
          if ("object" == typeof e || "function" == typeof e)
            if (T) {
              var n;
              for (var r in e)
                (n = Object.getOwnPropertyDescriptor(e, r)) && z(t, r, n);
            } else {
              var a = e && e.hasOwnProperty;
              for (var r in e)
                (!a || e.hasOwnProperty(r)) && (t[r] = e[r]);
            }
          return t["default"] = e, z(t, "__useDefault", {value: !0}), t;
        }
        function h(e, t, n) {
          for (var r in t)
            n && r in e || (e[r] = t[r]);
        ...
        z(r.prototype, "toString", {value: function() {
            return "Module";
          }}), function() {
          function o(e) {
            return {
          ...
          function g(e, n, r) {
            ...
            for (var u = e.loads.concat([]),
                ...
                d = u.length; d > o; o++) {
              var n = u[o];
              a.loaderObj.failed = a.loaderObj.failed || [], -1 == R.call(a.loaderObj.failed, n) && a.loaderObj.failed.push(n);
              var c = R.call(n.linkSets, e);
              if (n.linkSets.splice(c, 1), 0 == n.linkSets.length) {
                var f = R.call(e.loader.loads, n);
          ...
          function v(e, t) {
            ...
            var r = R.call(e.loads, t);
            -1 != r && e.loads.splice(r, 1);
            for (var a = 0,
                o = t.linkSets.length; o > a; a++)
              r = R.call(t.linkSets[a].loads, t), -1 != r && t.linkSets[a].loads.splice(r, 1);
        ...
        c(function(e) {
          return function() {
            e.call(this), this.baseURL = M.substr(0, M.lastIndexOf("/") + 1), this.warnings = !1, this.defaultJSExtensions = !1, this.globalEvaluationScope = !0, this.pluginFirst = !1, (j || O && window.chrome && window.chrome.extension || O && navigator.userAgent.match(/^Node\.js/)) && (this.globalEvaluationScope = !1), this.set("@empty", this.newModule({}));
          };
        }), d("normalize", function(e) {
          return function(t, n) {
            return t = e.apply(this, arguments), "." == t[0] || "/" == t[0] ? n ? new L(t, n.replace(/#/g, "%05")).href.replace(/%05/g, "#") : new L(t, q).href : t;
          };
        });
        ...
        d("locate", function(e) {
          ...
          if (e.packages)
            for (var n in e.packages) {
              ...
              for (var m in e.packages[n])
                -1 == R.call(U, m) && g.call(this, '"' + m + '" is not a valid package configuration option in package ' + n);
          ...
          return function(t, n) {
            ...
            return this.has(r) ? r : r.match(A) ? (this.defaultJSExtensions && ".js" != r.substr(r.length - 3, 3) && (r += ".js"), r) : (r = s(this.paths, r) || r, this.defaultJSExtensions && ".js" != r.substr(r.length - 3, 3) && (r += ".js"), "." == r[0] || "/" == r[0] ? new L(r, q).href : new L(r, y.call(this)).href);
          };
        }), function() {
          function e(e) {
            var t,
            ...
            return function(s, l, d) {
              ...
              return k.pkgName ? Promise.resolve(P(b, y)).then(function(e) {
                if (e || m[k.pkgName]) {
                  ...
                  return e && -1 == R.call(t.bundles, e) && (t.bundles.push(e), t.promise = Promise.all([t.promise, b.load(e)])), t.promise;
                }
              }).then(function() {
          ...
          function t(e, n, r) {
            if (r[e.groupIndex] = r[e.groupIndex] || [], -1 == R.call(r[e.groupIndex], e)) {
              ...
              for (var a = 0,
                ...
                if (i && !i.evaluated) {
                  ...
                  if (null === i.groupIndex || i.groupIndex < l) {
                    if (null !== i.groupIndex && (r[i.groupIndex].splice(R.call(r[i.groupIndex], i), 1), 0 == r[i.groupIndex].length))
          ...
          function u(t, n, r) {
            ...
            if (a && !a.evaluated && a.declarative) {
              ...
              for (var o = 0,
                ...
                -1 == R.call(n, i) && (r.defined[i] ? u(i, n, r) : r.get(i));
              }
          ...
          return function() {
            ...
            function a(t, a, o) {
              ...
              var l,
                  u,
                  d;
              -1 != (l = R.call(a, "require")) && (a.splice(l, 1), t || (a = a.concat(n(o.toString(), l)))), -1 != (u = R.call(a, "exports")) && a.splice(u, 1), -1 != (d = R.call(a, "module")) && a.splice(d, 1);
              var c = b();
        ...
        }), D = new l, D.version = "0.19.6 CSP", "object" == typeof exports && (module.exports = a), e.Reflect = e.Reflect || {}, e.Reflect.Loader = e.Reflect.Loader || a, e.Reflect.global = e.Reflect.global || e, e.LoaderPolyfill = a, D || (D = new o, D.constructor = o), "object" == typeof exports && (module.exports = D), e.System = D;
...
System.get("../../../../node_modules/systemjs/dist/system-csp-production.js" + '');
