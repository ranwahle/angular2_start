System.registerModule("../../../../node_modules/browser-sync/bin/browser-sync.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/browser-sync/bin/browser-sync.js";
  ...
  function listFlags(flags) {
    ...
    return flagKeys.map(function(item) {
      ...
      return "    {bold:--" + item + chars(length, " ") + "}" + flags[item];
    }).join("\n");
  }
...
System.get("../../../../node_modules/browser-sync/bin/browser-sync.js" + '');
