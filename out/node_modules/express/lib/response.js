System.registerModule("../../../../node_modules/express/lib/response.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/express/lib/response.js";
  var fs = require('fs'),
      http = require('http'),
      path = require('path'),
  ...
  res.redirect = function(url, status) {
    ...
    var mapped = 'function' == typeof map[url] ? map[url](req, this) : map[url];
    url = mapped || url;
    if (!~url.indexOf('://')) {
...
System.get("../../../../node_modules/express/lib/response.js" + '');
