System.registerModule("../../../node_modules/easy-extender/index.js", [], function() {
  "use strict";
  var __moduleName = "../../../node_modules/easy-extender/index.js";
  ...
  EasyExtender.prototype.initUserPlugins = function() {
    ...
    if (userPlugins.length) {
      userPlugins.forEach(function(plugin) {
        ...
        this.returnValues[plugin].push({value: this.get(plugin).apply(null, [pluginOptions].concat(args))});
...
System.get("../../../node_modules/easy-extender/index.js" + '');
