System.registerModule("../../../node_modules/parsejson/test.js", [], function() {
  "use strict";
  var __moduleName = "../../../node_modules/parsejson/test.js";
  var assert = require('better-assert');
  var expect = require('expect.js');
  var parsejson = require('./index.js');
  describe('my suite', function() {
    it('should parse a JSON string', function() {
      var jsonString = '{"users" :[{"first_name":"foo", "last_name":"bar"}],' + '"id"    :40,' + '"cities":["los angeles", "new york", "boston"]}';
...
System.get("../../../node_modules/parsejson/test.js" + '');
