System.registerModule("../../../../node_modules/readdirp/test/readdirp.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/readdirp/test/readdirp.js";
  ...
  test('\n\nreading root using function filter', function(t) {
    t.test('\n# file filter -> "contains root_dir2"', function(t) {
      t.plan(1);
      readdirp(opts({fileFilter: function(fi) {
          return fi.name.indexOf('root_dir2') >= 0;
        }}), function(err, res) {
    ...
    t.test('\n# directory filter -> "name has length 9"', function(t) {
      t.plan(1);
      readdirp(opts({directoryFilter: function(di) {
  ...
  test('\nprogress callbacks', function(t) {
    t.plan(2);
    var pluckName = function(fi) {
      return fi.name;
    },
        processedFiles = [];
    readdirp(opts(), function(fi) {
    ...
    opts.forEach(function(op) {
      ...
      t.test('\n' + util.inspect(op), function(t) {
        ...
        fs.realpath(op.root, function(err, fullRoot) {
          readdirp(op, function(err, res) {
            t.equals(res.files[0].fullParentDir, path.join(fullRoot, op.prefix, expected.parentDirName), 'correct parentDir');
            t.equals(res.files[0].fullPath, path.join(fullRoot, op.prefix, expected.parentDirName, expected.name), 'correct fullPath');
          });
        });
      });
    });
...
System.get("../../../../node_modules/readdirp/test/readdirp.js" + '');
