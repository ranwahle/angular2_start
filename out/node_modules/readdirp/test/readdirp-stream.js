System.registerModule("../../../../node_modules/readdirp/test/readdirp-stream.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/readdirp/test/readdirp-stream.js";
  var debug;
  ...
  test('\nintegrated', function(t) {
    t.test('\n# reading root without filter', function(t) {
      t.plan(2);
      readdirp(opts()).on('error', function(err) {
        t.fail('should not throw error', err);
      }).pipe(capture()).pipe(through.obj(function(result, _, cb) {
    ...
    t.test('\n# normal: ["*.ext1", "*.ext3"]', function(t) {
      t.plan(2);
      readdirp(opts({fileFilter: ['*.ext1', '*.ext3']})).on('error', function(err) {
        t.fail('should not throw error', err);
      }).pipe(capture()).pipe(through.obj(function(result, _, cb) {
    ...
    t.test('\n# files only', function(t) {
      t.plan(2);
      readdirp(opts({entryType: 'files'})).on('error', function(err) {
        t.fail('should not throw error', err);
      }).pipe(capture()).pipe(through.obj(function(result, _, cb) {
    ...
    t.test('\n# directories only', function(t) {
      t.plan(2);
      readdirp(opts({entryType: 'directories'})).on('error', function(err) {
        t.fail('should not throw error', err);
      }).pipe(capture()).pipe(through.obj(function(result, _, cb) {
    ...
    t.test('\n# both directories + files', function(t) {
      t.plan(2);
      readdirp(opts({entryType: 'both'})).on('error', function(err) {
        t.fail('should not throw error', err);
      }).pipe(capture()).pipe(through.obj(function(result, _, cb) {
  ...
  test('\napi separately', function(t) {
    ...
    t.test('\n# when a stream is destroyed, it emits "closed", but no longer emits "data", "warn" and "error"', function(t) {
      var api = streamapi(),
          ...
          plan = 0;
      t.plan(6);
      var stream = api.stream.on('warn', function(err) {
...
System.get("../../../../node_modules/readdirp/test/readdirp-stream.js" + '');
