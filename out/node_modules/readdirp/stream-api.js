System.registerModule("../../../node_modules/readdirp/stream-api.js", [], function() {
  "use strict";
  var __moduleName = "../../../node_modules/readdirp/stream-api.js";
  ...
  proto._handleError = function(err) {
    ...
    si(function() {
      if (self._paused)
        return self._warnings.push(err);
      if (!self._destroyed)
        self.emit('warn', err);
    });
  };
...
System.get("../../../node_modules/readdirp/stream-api.js" + '');
