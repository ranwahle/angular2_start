System.registerModule("../../../../node_modules/moment/min/locales.min.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/moment/min/locales.min.js";
  !function(a, b) {
    ...
    function m(a, b, c, d) {
      ...
      switch (c) {
        ...
        case "d":
          return b || d ? "den" : "dnem";
        case "dd":
          return b || d ? e + (l(a) ? "dny" : "dní") : e + "dny";
          break;
        case "M":
          return b || d ? "měsíc" : "měsícem";
        case "MM":
          return b || d ? e + (l(a) ? "měsíce" : "měsíců") : e + "měsíci";
          break;
        case "y":
    ...
    function z(a, b, c, d) {
      ...
      switch (c) {
        ...
        case "mm":
          return y(a) ? e + (b || d ? "mínútur" : "mínútum") : b ? e + "mínúta" : e + "mínútu";
        case "hh":
    ...
    function $(a, b, c, d) {
      ...
      switch (c) {
        ...
        case "h":
          return b ? "hodina" : d ? "hodinu" : "hodinou";
        case "hh":
          return b || d ? e + (Z(a) ? "hodiny" : "hodín") : e + "hodinami";
          break;
        case "d":
          return b || d ? "deň" : "dňom";
        case "dd":
          return b || d ? e + (Z(a) ? "dni" : "dní") : e + "dňami";
          break;
        case "M":
    ...
    var ga = (a.defineLocale("af", {
      ...
      0: "٠"
        ...
        na = ["كانون الثاني يناير", "شباط فبراير", "آذار مارس", "نيسان أبريل", "أيار مايو", "حزيران يونيو", "تموز يوليو", "آب أغسطس", "أيلول سبتمبر", "تشرين الأول أكتوبر", "تشرين الثاني نوفمبر", "كانون الأول ديسمبر"],
        ...
        Ha = "sekmadienis_pirmadienis_antradienis_trečiadienis_ketvirtadienis_penktadienis_šeštadienis".split("_"),
...
System.get("../../../../node_modules/moment/min/locales.min.js" + '');
