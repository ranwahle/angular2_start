System.registerModule("../../../../node_modules/browser-sync-client/dist/index.min.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/browser-sync-client/dist/index.min.js";
  !function t(e, n, o) {
    function i(s, c) {
      if (!n[s]) {
        if (!e[s]) {
    ...
    4: [function(t, e, n) {
      ...
      c.init = function(t) {
        t.options.tagNames && (a.tagNames = t.options.tagNames), "window.name" === t.options.scrollRestoreTechnique ? c.saveScrollInName(s) : c.saveScrollInCookie(r.getWindow(), r.getDocument()), t.socket.on("file:reload", c.reload(t)), t.socket.on("browser:reload", function() {
          t.canSync({url: u()}, l) && c.reloadBrowser(!0, t);
        });
        ...
        s.on("browser:hardReload", function(n) {
          var i = [o.name, t, JSON.stringify({bs: {
              hardReload: !0,
        ...
        return function(e) {
          if (t.canSync({url: u()}, l)) {
            ...
            if ((e.url || !o.injectChanges) && c.reloadBrowser(!0), e.basename && e.ext) {
              ...
              s.length && o.notify && i.emit("notify", {message: "Injected: " + e.basename});
              for (var a = 0,
                  d = s.length; d > a; a += 1)
                n = c.swapFile(s[a], r.attr, o);
            }
            return n;
          }
        };
        ...
        s.emit("browser:hardReload", {scrollPosition: r.getBrowserScrollPosition()}), t && r.reloadBrowser();
      };
    }, {
      "./browser.utils": 2,
      "./emitter": 5,
    ...
    5: [function(t, e, n) {
      ...
      n.events = {}, n.emit = function(t, e) {
        ...
        var o = n.events;
        o[t] ? o[t].listeners.push(e) : o[t] = {listeners: [e]};
      };
    }, {}],
    6: [function(t, e, n) {
        ...
        return function(e) {
          if (n.canEmitEvents) {
            ...
            if ("checkbox" === i.type || "radio" === i.type)
              return void t.utils.forceChange(i);
    ...
    14: [function(t, e, n) {
      ...
      n.canEmitEvents = !0, n.init = function(t, e) {
        ...
        return function() {
          ...
          e && t.socket.emit(i, {position: n.getScrollPosition()}), n.canEmitEvents = !0;
        };
    ...
    16: [function(t, e, n) {
      ...
      var o,
          i,
          r,
          s = (t("./ghostmode.scroll"), t("./browser.utils")),
          c = {
            display: "none",
            padding: "15px",
      ...
      n.init = function(t) {
        ...
        var e = c;
        if (i.notify.styles)
          if ("[object Array]" === Object.prototype.toString.call(i.notify.styles))
            e = i.notify.styles.join(";");
          else
            for (var r in i.notify.styles)
              i.notify.styles.hasOwnProperty(r) && (e[r] = i.notify.styles[r]);
        if (o = document.createElement("DIV"), o.id = "__bs_notify__", "string" == typeof e)
          o.style.cssText = e;
        else
          for (var s in e)
            o.style[s] = e[s];
...
System.get("../../../../node_modules/browser-sync-client/dist/index.min.js" + '');
