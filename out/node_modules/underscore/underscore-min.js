System.registerModule("../../../node_modules/underscore/underscore-min.js", [], function() {
  "use strict";
  var __moduleName = "../../../node_modules/underscore/underscore-min.js";
  (function() {
    var n = this,
        t = n._,
        r = Array.prototype,
    ...
    h.flatten = function(n, t) {
      ...
      if (null == n)
        return [];
      for (var t = h.max(arguments, "length").length,
          r = Array(t),
          e = 0; t > e; e++)
...
System.get("../../../node_modules/underscore/underscore-min.js" + '');
