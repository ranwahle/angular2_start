System.registerModule("../../../../node_modules/stream-throttle/bin/throttleproxy.js", [], function() {
  "use strict";
  var __moduleName = "../../../../node_modules/stream-throttle/bin/throttleproxy.js";
  var net = require('net');
  ...
  function main() {
    var localAddr,
        ...
        downRate,
        upRate;
    opts.option('-l, --localaddr <addr>', 'local address, default 0.0.0.0:8080').option('-r, --remoteaddr <addr>', 'remote address, default localhost:80').option('-d, --downstream <bps>', 'downstream bandwidth', parseInteger).option('-u, --upstream <bps>', 'upstream bandwidth, default equal to downstream', parseInteger).parse(process.argv);
...
System.get("../../../../node_modules/stream-throttle/bin/throttleproxy.js" + '');
