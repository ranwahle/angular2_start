System.registerModule("../../../../../node_modules/bluebird/js/browser/bluebird.min.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../node_modules/bluebird/js/browser/bluebird.min.js";
  !function(t) {
    ...
    return function n(t, e, r) {
      ...
      2: [function(t, e) {
        ...
        r.prototype.haveItemsQueued = function() {
        ...
        }, r.prototype._withDomain = function(t) {
          return void 0 === a || null == a.domain || t.domain || (t = a.domain.bind(t)), t;
        }, r.prototype.throwLater = function(t, e) {
          if (1 === arguments.length && (e = t, t = function() {
            throw e;
          }), t = this._withDomain(t), "undefined" != typeof setTimeout)
            setTimeout(function() {
              t(e);
            }, 0);
          else
          ...
          this._isTickUsed = !1;
        }, e.exports = new r, e.exports.firstLineError = n;
      }, {
        "./queue.js": 28,
        "./schedule.js": 31
      }],
      3: [function(t, e) {
        ...
        e.exports = function(t, e, r) {
          ...
          function o(t) {
            return this._then(n, null, null, {value: t}, void 0);
          }
          function s(t) {
            return this._then(i, i, null, {reason: t}, void 0);
          }
          function a(t) {
            this._setBoundTo(t);
          }
          t.prototype.bind = function(e) {
            ...
            if (n instanceof t) {
              if (!n.isFulfilled()) {
                if (n.isRejected())
                  return t.reject(n.reason());
                var i = this.then(),
                    u = i;
                return i = i._then(o, s, null, n, void 0), n._then(a, i._reject, null, i, null), i._cancellable() || i._setPendingCancellationParent(u), i;
              }
              e = n.value();
            }
            var i = this.then();
          ...
          }, t.prototype._setPendingCancellationParent = function(t) {
            this._settledValue = t;
          }, t.prototype._pendingCancellationParent = function() {
            if (this.isPending() && void 0 !== this._settledValue) {
              var t = this._settledValue;
              return t.cancellable(), this._settledValue = void 0, t;
            }
          }, t.prototype._setIsMigratingBinding = function() {
            this._bitField = 8388608 | this._bitField;
          }, t.prototype._unsetIsMigratingBinding = function() {
            this._bitField = -8388609 & this._bitField;
          }, t.prototype._isMigratingBinding = function() {
            return 8388608 === (8388608 & this._bitField);
          }, t.prototype._setBoundTo = function(t) {
            this._boundTo = t;
          }, t.prototype._isBound = function() {
            return void 0 !== this._boundTo;
          };
        };
      }, {}],
      4: [function(t, e) {
        ...
        e.exports = function(e) {
          ...
          e.prototype._cancel = function(t) {
            if (!this.isCancellable())
              return this;
            for (var e = void 0,
                r = this; void 0 !== (e = r._cancellationParent) && e.isCancellable(); )
              r = e;
        ...
        e.exports = function() {
          ...
          h.inherits(e, Error), e.prototype.uncycle = function() {
            ...
            if (!t.__stackCleaned__) {
              this.uncycle();
              for (var s = e.parseStackAndMessage(t),
                  a = s.message,
                  u = [s.stack],
                  c = this; void 0 !== c; )
            ...
            if ("object" == typeof console) {
              ...
              if ("object" == typeof t || "function" == typeof t) {
                ...
                r = e + String(t);
              "function" == typeof console.warn || "object" == typeof console.warn ? console.warn(r) : ("function" == typeof console.log || "object" == typeof console.log) && console.log(r);
            }
            ...
            a || o || u || "unhandledRejection" !== t || e.formatAndLogError(n, "Possibly unhandled ");
          };
          var v = function() {
            return !1;
          },
          ...
          e.setBounds = function(t, r) {
            if (e.isSupported()) {
              ...
              0 > a || 0 > u || !n || !i || n !== i || a >= u || (v = function(t) {
                if (p.test(t))
                  return !0;
                var e = c(t);
              ...
              j = function() {
                ...
                e && (g = function(e, r) {
                  ...
                  return t ? n = new self.CustomEvent(e, {
                    ...
                    bubbles: !1,
                    cancelable: !0
                  }) : self.dispatchEvent && (n = document.createEvent("CustomEvent"), n.initCustomEvent(e, !1, !0, r)), n ? !self.dispatchEvent(n) : !1;
                });
                var o = {};
                return o.unhandledRejection = "onunhandledRejection".toLowerCase(), o.rejectionHandled = "onrejectionHandled".toLowerCase(), function(t, e, r) {
                  var n = o[t],
                      i = self[n];
        ...
        e.exports = function(e) {
          ...
          return r.prototype.doFilter = function(t) {
            for (var r = this._callback,
                ...
                o = i._boundTo,
                u = 0,
                c = this._instances.length; c > u; ++u) {
      ...
      9: [function(t, e) {
        ...
        e.exports = function(t, e, r) {
          ...
          }, t.prototype._peekContext = o, t.prototype._pushContext = n.prototype._pushContext, t.prototype._popContext = n.prototype._popContext, i;
        };
      }, {}],
      10: [function(t, e) {
        "use strict";
        e.exports = function(e, r) {
          var n,
              ...
              a = t("./util.js"),
              u = a.canAttachTrace,
              c = !1 || a.isNode && (!!process.env.BLUEBIRD_DEBUG || "development" === process.env.NODE_ENV);
          return e.prototype._ensurePossibleRejectionHandled = function() {
            this._setRejectionIsUnhandled(), o.invokeLater(this._notifyUnhandledRejection, this, void 0);
            ...
            if (this._isRejectionUnhandled()) {
              ...
              this._setUnhandledRejectionIsNotified(), r.fireRejectionEvent("unhandledRejection", i, t, this);
            }
            ...
            if (o.haveItemsQueued() && c === !1)
              throw new Error("cannot enable long stack traces after promises have been created\n\n    See http://goo.gl/DT1qyG\n");
            c = r.isSupported();
          }, e.hasLongStackTraces = function() {
            return c && r.isSupported();
          }, r.isSupported() || (e.longStackTraces = function() {}, c = !1), function() {
            return c;
          };
        };
      }, {
      ...
      11: [function(t, e) {
        ...
        e.exports = function(t) {
          ...
          t.prototype["return"] = t.prototype.thenReturn = function(t) {
            return i && n(t) ? this._then(o(t, 2), void 0, void 0, void 0, void 0) : this._then(e, void 0, void 0, t, void 0);
          }, t.prototype["throw"] = t.prototype.thenThrow = function(t) {
            return i && n(t) ? this._then(o(t, 1), void 0, void 0, void 0, void 0) : this._then(r, void 0, void 0, t, void 0);
          };
        };
      }, {"./util.js": 38}],
      12: [function(t, e) {
      ...
      13: [function(t, e) {
        ...
        function r(t, e) {
          function r(n) {
            return this instanceof r ? (c(this, "message", "string" == typeof n ? n : e), c(this, "name", t), void(Error.captureStackTrace ? Error.captureStackTrace(this, this.constructor) : Error.call(this))) : new r(n);
          }
          return u(r, Error), r;
        }
        function n(t) {
        ...
        for (var d = "join pop push shift unshift slice filter forEach some every map indexOf lastIndexOf reduce reduceRight sort reverse".split(" "),
            v = 0; v < d.length; ++v)
          "function" == typeof Array.prototype[d[v]] && (f.prototype[d[v]] = Array.prototype[d[v]]);
        ...
        g || (g = s({
          ...
          RejectionError: n,
          AggregateError: f
        }), c(Error, "__BluebirdErrorTypes__", g)), e.exports = {
          Error: Error,
          TypeError: i,
          RangeError: o,
        ...
        e.exports = function(e, r, n) {
          ...
          function c(t) {
            ...
            if (void 0 !== s) {
              var a = n(s, i);
              if (a instanceof e)
                return a = a._target(), u(a, t, i.isFulfilled());
            }
          ...
          function l(t) {
            var r = this.promise,
                i = this.handler,
                o = r._isBound() ? i.call(r._boundTo, t) : i(t);
            if (void 0 !== o) {
              var s = n(o, r);
              if (s instanceof e)
                return s = s._target(), u(s, t, !0);
            }
            return t;
          }
          var h = t("./util.js"),
              p = h.wrapsPrimitiveReceiver,
              f = h.isPrimitive,
              _ = h.thrower;
      ...
      17: [function(t, e) {
        ...
        e.exports = function(e, r, n, i) {
          ...
          function s(t, r, i, o) {
            ...
            s._captureStackTrace(), this._stack = o, this._generatorFunction = t, this._receiver = r, this._generator = void 0, this._yieldHandlers = "function" == typeof i ? [i].concat(p) : p;
          }
          var a = t("./errors.js"),
              u = a.TypeError,
              c = t("./util.js"),
          ...
          s.prototype.promise = function() {
            ...
            if (t.done === !0)
              ...
              if (!(n instanceof e) && (n = o(n, this._yieldHandlers, this._promise), null === n))
                return void this._throw(new u("A value %s was yielded that could not be treated as a promise\n\n    See http://goo.gl/4Y4pDk\n\n".replace("%s", r) + "From coroutine:\n" + this._stack.split("\n").slice(1, -7).join("\n")));
      ...
      19: [function(t, e) {
        ...
        e.exports = function(e, r, n, i, o) {
          function s(t, e, r, n) {
            this.constructor$(t), this._promise._setIsSpreadable(), this._promise._captureStackTrace(), this._callback = e, this._preservedValues = n === o ? new Array(this.length()) : null, this._limit = r, this._inFlight = 0, this._queue = r >= 1 ? [] : p, this._init$(void 0, -2);
          }
          function a(t, e, r, n) {
          ...
          var u = t("./util.js"),
              ...
              h = {},
              p = [];
          u.inherits(s, r), s.prototype._init = function() {}, s.prototype._promiseFulfilled = function(t, r) {
            var n = this._values,
                o = this.length(),
        ...
        e.exports = function(e, r) {
          ...
          e.prototype.progressed = function(t) {
            ...
            if (c === s) {
              ...
              c instanceof e ? c._then(a._progress, null, null, a, void 0) : a._progress(c);
          }, e.prototype._progressUnchecked = function(t) {
            for (var n = this._length(),
                o = this._progress,
                s = 0; n > s; s++) {
      ...
      23: [function(t, e) {
        ...
        e.exports = function() {
          function e(t) {
            ...
            this._bitField = 0, this._fulfillmentHandler0 = void 0, this._rejectionHandler0 = void 0, this._progressHandler0 = void 0, this._promise0 = void 0, this._receiver0 = void 0, this._settledValue = void 0, this._boundTo = void 0, t !== c && this._resolveFromResolver(t);
          }
          var r = function() {
          ...
          return e.prototype.toString = function() {
            ...
            var l = this._target();
            l !== this && (a || (u._setIsMigrated(), void 0 === i && (u._setIsMigratingBinding(), i = this)));
            var h = l._addCallbacks(t, r, n, u, i);
            return l._isResolved() && !l._isSettlePromisesQueued() && s.invoke(l._settlePromiseAtPostResolution, l, h), u;
          ...
          }, e.prototype._isSpreadable = function() {
            return (131072 & this._bitField) > 0;
          }, e.prototype._setIsSpreadable = function() {
            ...
            var n = t._fulfillmentHandlerAt(r),
                ...
                s = t._promiseAt(r),
                a = t._receiverAt(r);
            s instanceof e && (s._setIsMigrated(), void 0 === a && (a = t, s._setIsMigratingBinding())), this._addCallbacks(n, i, o, s, a);
          }, e.prototype._addCallbacks = function(t, e, r, n, i) {
            var o = this._length();
            if (o >= 131066 && (o = 0, this._setLength(0)), 0 === o)
              this._promise0 = n, void 0 !== i && (this._receiver0 = i), "function" != typeof t || this._isCarryingStackTrace() || (this._fulfillmentHandler0 = t), "function" == typeof e && (this._rejectionHandler0 = e), "function" == typeof r && (this._progressHandler0 = r);
            else {
              var s = 5 * o - 5;
              this[s + 3] = n, this[s + 4] = i, "function" == typeof t && (this[s + 0] = t), "function" == typeof e && (this[s + 1] = e), "function" == typeof r && (this[s + 2] = r);
            }
            ...
            r = !1, this._popContext(), void 0 !== n && n === j && null !== e && (e._rejectCallback(n.e, !0, !0), e = null);
          }, e.prototype._settlePromiseFromHandler = function(t, e, n, i) {
            if (!i._isRejected()) {
              i._pushContext();
              var o;
              if (o = e !== l || this._isRejected() ? b(t).call(e, n) : b(t).apply(this._boundTo, n), i._popContext(), o === j || o === i || o === h) {
                var s = o === i ? r() : o.e;
            ...
            (1 & e) > 0 && t._cancellable() && (this._setCancellable(), this._cancellationParent = t), (4 & e) > 0 && this._setBoundTo(t._boundTo);
            ...
            n && r._isMigratingBinding() && (r._unsetIsMigratingBinding(), u = u._boundTo), this._clearCallbackDataAtIndex(t), "function" == typeof i ? n ? this._settlePromiseFromHandler(i, u, a, r) : i.call(u, a, r) : u instanceof f ? u._isResolved() || (this._isFulfilled() ? u._promiseFulfilled(a, r) : u._promiseRejected(a, r)) : n && (this._isFulfilled() ? r._fulfill(a) : r._reject(a, o)), t >= 4 && 4 === (31 & t) && s.invokeLater(this._setLength, this, 0);
          }, e.prototype._clearCallbackDataAtIndex = function(t) {
            if (0 === t)
              this._isCarryingStackTrace() || (this._fulfillmentHandler0 = void 0), this._rejectionHandler0 = this._progressHandler0 = this._receiver0 = this._promise0 = void 0;
            else {
              var e = 5 * t - 5;
            ...
            return this._setRejected(), this._settledValue = t, this._cleanValues(), this._isFinal() ? void s.throwLater(function(t) {
      ...
      24: [function(t, e) {
        ...
        e.exports = function(e, r, n, i) {
          ...
          function s(t) {
            ...
            t instanceof e && (n = t, i._propagateFrom(n, 5)), this._values = t, this._length = 0, this._totalResolved = 0, this._init(void 0, -2);
          }
          var a = t("./util.js"),
              u = a.isArray;
          return s.prototype.length = function() {
            ...
            if (s instanceof e) {
              if (s._setBoundTo(this._promise._boundTo), s = s._target(), this._values = s, !s._isFulfilled())
                return s._isPending() ? void s._then(c, this._reject, void 0, this, r) : void this._reject(s._reason());
              if (s = s._value(), !u(s)) {
            ...
            if (0 === s.length)
              return void(-5 === r ? this._resolveEmptyArray() : this._resolve(o(r)));
            ...
            for (var h = this._promise,
              ...
              var f = this._isResolved(),
                  _ = n(s[p], h);
              _ instanceof e ? (_ = _._target(), f ? _._unsetRejectionIsUnhandled() : _._isPending() ? _._proxyPromiseArray(this, p) : _._isFulfilled() ? this._promiseFulfilled(_._value(), p) : this._promiseRejected(_._reason(), p)) : f || this._promiseFulfilled(_, p);
            }
      ...
      26: [function(t, e) {
        ...
        e.exports = function(e, r) {
          ...
          function s(t, e, r, s) {
            for (var a = p.inheritedDataKeys(t),
                u = [],
                c = 0; c < a.length; ++c) {
              var l = a[c],
                  h = t[l],
          ...
          function u(t, e, r, n) {
            for (var i = new RegExp(b(e) + "$"),
              ...
              var c = o[a],
                  l = o[a + 1],
                  f = c + e;
              t[f] = n === w ? w(c, h, c, l, e) : n(l, function() {
                return w(c, h, c, l, e);
              });
            }
          ...
          var l,
              ...
              g = "Async",
              m = function(t, e) {
                return p.isIdentifier(t) && "_" !== t.charAt(0) && !p.isClass(e);
              },
          ...
          e.promisify = function(t, e) {
            ...
            var i = e.promisifier;
            if ("function" != typeof i && (i = w), !p.isIdentifier(r))
              throw new RangeError("suffix must be a valid identifier\n\n    See http://goo.gl/8FZo5V\n");
            for (var o = p.inheritedDataKeys(t, {includeHidden: !0}),
                s = 0; s < o.length; ++s) {
              var a = t[o[s]];
      ...
      30: [function(t, e) {
        ...
        e.exports = function(e, r, n, i, o) {
          function s(t, r, n, s) {
            this.constructor$(t), this._promise._captureStackTrace(), this._preservedValues = s === o ? [] : null, this._zerothIsAccum = void 0 === n, this._gotAccum = !1, this._reducingIndex = this._zerothIsAccum ? 1 : 0, this._valuesPhase = void 0;
            var a = i(n, this._promise),
                u = !1,
                c = a instanceof e;
            c && (a = a._target(), a._isPending() ? a._proxyPromiseArray(this, -1) : a._isFulfilled() ? (n = a._value(), this._gotAccum = !0) : (this._reject(a._reason()), u = !0)), c || this._zerothIsAccum || (this._gotAccum = !0), this._callback = r, this._accum = n, u || this._init$(void 0, -5);
          }
          function a(t, e, r, i) {
            if ("function" != typeof e)
          ...
          var u = t("./util.js"),
              c = u.tryCatch,
              l = u.errorObj;
          u.inherits(s, r), s.prototype._init = function() {}, s.prototype._resolveEmptyArray = function() {
            ...
            var o,
                ...
                p = this._valuesPhase;
            if (!p)
              for (p = this._valuesPhase = new Array(s), o = 0; s > o; ++o)
                p[o] = 0;
            if (o = p[r], 0 === r && this._zerothIsAccum ? (this._accum = t, this._gotAccum = h = !0, p[r] = 0 === o ? 1 : 2) : -1 === r ? (this._accum = t, this._gotAccum = h = !0) : 0 === o ? p[r] = 1 : (p[r] = 2, this._accum = t), h) {
              for (var f = void 0,
                  _ = this._callback,
                  d = this._promise._boundTo,
                  v = this._reducingIndex; s > v; ++v)
                if (o = p[v], 2 !== o) {
                  if (1 !== o)
                    return;
                  if (t = n[v], this._promise._pushContext(), u ? (a.push(t), f = c(_).call(d, t, v, s)) : f = c(_).call(d, this._accum, t, v, s), this._promise._popContext(), f === l)
                    return this._reject(f.e);
                  var y = i(f, this._promise);
                  if (y instanceof e) {
                    if (y = y._target(), y._isPending())
                      return p[v] = 4, y._proxyPromiseArray(this, v);
                    if (!y._isFulfilled())
      ...
      31: [function(t, e) {
        ...
        if (t("./util.js").isNode) {
          ...
          "undefined" != typeof MutationObserver ? (r = function(t) {
            var e = document.createElement("div"),
                r = new MutationObserver(t);
            return r.observe(e, {attributes: !0}), function() {
              e.classList.toggle("foo");
            };
          }, r.isStatic = !0) : r = "undefined" != typeof setTimeout ? function(t) {
            setTimeout(t, 0);
          } : function() {
            throw new Error("No async scheduler available\n\n    See http://goo.gl/m3OTXk\n");
          };
      ...
      32: [function(t, e) {
        ...
        e.exports = function(e, r) {
          function n(t) {
            this.constructor$(t), this._promise._setIsSpreadable();
          }
        ...
        e.exports = function(e, r, n) {
          ...
          s.inherits(i, r), i.prototype._init = function() {
            if (this._initialized) {
              if (this._promise._setIsSpreadable(), 0 === this._howMany)
            ...
            this._addFulfilled(t), this._fulfilled() === this.howMany() && (this._values.length = this.howMany(), this._resolve(1 === this.howMany() && this._unwrap ? this._values[0] : this._values));
          }, i.prototype._promiseRejected = function(t) {
            if (this._addRejected(t), this.howMany() > this._canPossiblyFulfill()) {
              for (var e = new u,
                  r = this.length(); r < this._values.length; ++r)
      ...
      35: [function(t, e) {
        ...
        e.exports = function(e, r) {
          ...
          function s(t, n, i) {
            function o(r) {
              l && (t === r ? l._rejectCallback(e._makeSelfResolutionError(), !1, !0) : l._resolveCallback(r), l = null);
            }
            function s(t) {
          ...
          h.prototype.data = function() {
            ...
            for (var s = new Array(t),
              ...
              if (h.isDisposer(u)) {
                ...
                var _ = n(u);
                _ instanceof e && (u = _._then(f, null, null, {
                  resources: s,
                  index: a
                }, void 0));
              }
      ...
      38: [function(t, e, r) {
        ...
        var w = t("./es5.js"),
            ...
            E = function() {
              try {
                var t = {};
                return w.defineProperty(t, "f", {get: function() {
                    return 3;
                  }}), 3 === t.f;
              } catch (e) {
                return !1;
            ...
            P = function() {
              return w.isES5 ? function(t, e) {
                for (var r = [],
                    n = Object.create(null),
                    i = Object(e).includeHidden ? Object.getOwnPropertyNames : Object.keys; null != t; ) {
                  var o = void 0;
                  try {
                    o = i(t);
                  } catch (s) {
...
System.get("../../../../../node_modules/bluebird/js/browser/bluebird.min.js" + '');
