System.registerModule("../../../../../../node_modules/portscanner/node_modules/async/test/test-async.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/portscanner/node_modules/async/test/test-async.js";
  ...
  exports['apply'] = function(test) {
    ...
    async.apply(fn, 1)(2, 3, 4);
    async.apply(fn)(1, 2, 3, 4);
    test.equals(async.apply(function(name) {
      return 'hello ' + name;
    }, 'world')(), 'hello world');
    test.done();
  };
  ...
  exports['noConflict - node only'] = function(test) {
    if (typeof process !== 'undefined') {
      ...
      fs.readFile(filename, function(err, content) {
        ...
        var s2 = new Script(content + 'this.async2 = this.async.noConflict();', filename);
  ...
  exports['until'] = function(test) {
    ...
    async.until(function() {
      ...
      test.same(call_order, [['test', 0], ['iterator', 0], ['test', 1], ['iterator', 1], ['test', 2], ['iterator', 2], ['test', 3], ['iterator', 3], ['test', 4], ['iterator', 4], ['test', 5]]);
      test.equals(count, 5);
      test.done();
    });
  };
  ...
  exports['queue'] = function(test) {
    ...
    setTimeout(function() {
      test.same(call_order, ['process 2', 'callback 2', 'process 1', 'callback 1', 'process 4', 'callback 4', 'process 3', 'callback 3']);
      test.equal(q.concurrency, 2);
      test.equal(q.length(), 0);
      test.done();
    }, 200);
  ...
  exports['queue changing concurrency'] = function(test) {
    ...
    q.concurrency = 1;
    setTimeout(function() {
      test.same(call_order, ['process 1', 'callback 1', 'process 2', 'callback 2', 'process 3', 'callback 3', 'process 4', 'callback 4']);
  ...
  exports['falsy return values in parallel'] = function(test) {
    ...
    ;
    async.parallel([taskFalse, taskUndefined, taskEmpty, taskNull], function(err, results) {
      test.equal(results.length, 4);
      test.strictEqual(results[0], false);
      test.strictEqual(results[1], undefined);
      test.strictEqual(results[2], undefined);
  ...
  exports['queue events'] = function(test) {
    ...
    q.drain = function() {
      ...
      calls.push('drain');
      test.same(calls, ['saturated', 'process foo', 'foo cb', 'process bar', 'bar cb', 'process zoo', 'zoo cb', 'process poo', 'poo cb', 'empty', 'process moo', 'moo cb', 'drain']);
      test.done();
    };
    q.push('foo', function() {
      calls.push('foo cb');
...
System.get("../../../../../../node_modules/portscanner/node_modules/async/test/test-async.js" + '');
