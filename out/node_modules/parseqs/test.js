System.registerModule("../../../node_modules/parseqs/test.js", [], function() {
  "use strict";
  var __moduleName = "../../../node_modules/parseqs/test.js";
  ...
  describe('querystring test suite', function() {
    ...
    it('should construct a query string from an object', function() {
      ...
      expect(util.encode({
        a: 'b',
        c: 'tobi rocks'
      })).to.be('a=b&c=tobi%20rocks');
    });
  });
  return {};
});
System.get("../../../node_modules/parseqs/test.js" + '');
