System.registerModule("../../../../../../node_modules/fsevents/node_modules/node-pre-gyp/lib/install.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/node-pre-gyp/lib/install.js";
  ...
  function download(uri, opts, callback) {
    ...
    var requestOpts = {
      uri: uri.replace('+', '%2B'),
      headers: {'User-Agent': 'node-pre-gyp (node ' + process.version + ')'}
    };
  ...
  function place_binary(from, to, opts, callback) {
    download(from, opts, function(err, req) {
      if (err)
        return callback(err);
      if (!req)
        return callback(new Error("empty req"));
      var badDownload = false;
      var extractCount = 0;
      var gunzip = zlib.createGunzip();
      var extracter = require('tar').Extract({
        path: to,
        strip: 1
      });
      function afterTarball(err) {
        if (err)
          return callback(err);
        if (badDownload)
          return callback(new Error("bad download"));
        if (extractCount === 0) {
...
System.get("../../../../../../node_modules/fsevents/node_modules/node-pre-gyp/lib/install.js" + '');
