System.registerModule("../../../../../../node_modules/fsevents/node_modules/node-pre-gyp/lib/publish.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/node-pre-gyp/lib/publish.js";
  ...
  function publish(gyp, argv, callback) {
    ...
    existsAsync(tarball, function(found) {
      ...
      s3.headObject(s3_opts, function(err, meta) {
        if (meta)
          log.info('publish', JSON.stringify(meta));
        if (err && err.code == 'NotFound') {
          ...
          try {
            s3_put.putObject(s3_put_opts, function(err, resp) {
              ...
              if (resp)
                log.info('publish', 's3 putObject response: "' + JSON.stringify(resp) + '"');
...
System.get("../../../../../../node_modules/fsevents/node_modules/node-pre-gyp/lib/publish.js" + '');
