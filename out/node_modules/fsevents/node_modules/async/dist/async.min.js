System.registerModule("../../../../../../node_modules/fsevents/node_modules/async/dist/async.min.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/async/dist/async.min.js";
  !function() {
    function n() {}
    function t(n) {
      return n;
    ...
    function m(n, t) {
      return t = null == t ? n.length - 1 : +t, function() {
        for (var e = Math.max(arguments.length - t, 0),
            r = Array(e),
            u = 0; e > u; u++)
          r[u] = arguments[u + t];
        switch (t) {
    ...
    function x(t, e, r) {
      function i(t, e, r, u) {
        ...
        return t.started = !0, M(e) || (e = [e]), 0 === e.length && t.idle() ? C.setImmediate(function() {
          t.drain();
        }) : (c(e, function(e) {
          var i = {
            data: e,
      ...
      var f = 0,
          ...
          s = {
            ...
            resume: function() {
              if (s.paused !== !1) {
                s.paused = !1;
                for (var n = Math.min(s.concurrency, s.tasks.length),
                    t = 1; n >= t; t++)
    ...
    null != P && (q = P.async), C.noConflict = function() {
      return P.async = q, C;
    };
    ...
    "object" == typeof process && "function" == typeof process.nextTick ? C.nextTick = process.nextTick : C.nextTick = D, C.setImmediate = B ? D : C.nextTick, C.forEach = C.each = function(n, t, e) {
      return C.eachOf(n, y(t), e);
    }, C.forEachSeries = C.eachSeries = function(n, t, e) {
      return C.eachOfSeries(n, y(t), e);
    }, C.forEachLimit = C.eachLimit = function(n, t, e, r) {
      return v(t)(n, y(e), r);
    }, C.forEachOf = C.eachOf = function(t, e, r) {
      function o(n) {
      ...
      var c = h(t),
          a = c();
      o();
    }, C.forEachOfLimit = C.eachOfLimit = function(n, t, e, r) {
      v(t)(n, e, r);
    }, C.map = d(b), C.mapSeries = k(b), C.mapLimit = g(b), C.inject = C.foldl = C.reduce = function(n, t, e, r) {
      C.eachOfSeries(n, function(n, r, u) {
        e(t, n, function(n, e) {
          t = e, u(n);
        });
      }, function(n) {
    ...
    }, C.foldr = C.reduceRight = function(n, e, r, u) {
      var i = a(n, t).reverse();
      C.reduce(i, e, r, u);
    }, C.transform = function(n, t, e, r) {
      3 === arguments.length && (r = e, e = t, t = M(n) ? [] : {}), C.eachOf(n, function(n, r, u) {
        e(t, n, r, u);
      }, function(n) {
        r(n, t);
      });
    ...
    }), C.concat = d(I), C.concatSeries = k(I), C.whilst = function(t, e, r) {
      if (r = r || n, t()) {
      ...
      function i(t, e, i, o) {
        if (null != o && "function" != typeof o)
          throw new Error("task callback must be a function");
        return t.started = !0, M(e) || (e = [e]), 0 === e.length ? C.setImmediate(function() {
          t.drain();
        }) : void c(e, function(e) {
          var c = {
            data: e,
      ...
      return x(n, 1, t);
    }, C.log = j("log"), C.dir = j("dir"), C.memoize = function(n, e) {
      var r = {},
          u = {};
      e = e || t;
      var i = m(function(t) {
        var i = t.pop(),
            o = e.apply(null, t);
        o in r ? C.setImmediate(function() {
          i.apply(null, r[o]);
        }) : o in u ? u[o].push(i) : (u[o] = [i], n.apply(null, t.concat([m(function(n) {
          r[o] = n;
          var t = u[o];
          delete u[o];
          for (var e = 0,
    ...
    }, C.times = A(C.map), C.timesSeries = A(C.mapSeries), C.timesLimit = function(n, t, e, r) {
      ...
      return m(function(e) {
        var r = this,
            u = e[e.length - 1];
        "function" == typeof u ? e.pop() : u = n, C.reduce(t, e, function(n, t, e) {
    ...
    }, C.applyEach = T(C.eachOf), C.applyEachSeries = T(C.eachOfSeries), C.forever = function(t, e) {
      function r(n) {
      ...
      var i = u(e || n),
          o = z(t);
      r();
    }, C.ensureAsync = z, C.constant = m(function(n) {
      var t = [null].concat(n);
      return function(n) {
        return n.apply(this, t);
      };
    }), C.wrapSync = C.asyncify = function(n) {
      return m(function(t) {
        var e,
            r = t.pop();
        try {
    ...
    }, "object" == typeof module && module.exports ? module.exports = C : "function" == typeof define && define.amd ? define([], function() {
      return C;
    }) : P.async = C;
  }();
  return {};
});
System.get("../../../../../../node_modules/fsevents/node_modules/async/dist/async.min.js" + '');
