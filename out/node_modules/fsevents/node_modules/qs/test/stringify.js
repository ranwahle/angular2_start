System.registerModule("../../../../../../node_modules/fsevents/node_modules/qs/test/stringify.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/qs/test/stringify.js";
  ...
  describe('stringify()', function() {
    ...
    it('omits nested nulls when asked', function(done) {
      expect(Qs.stringify({a: {
          b: 'c',
          d: null
        }}, {skipNulls: true})).to.equal('a%5Bb%5D=c');
      done();
    });
    ...
    it('stringifies an empty value', function(done) {
      ...
      expect(Qs.stringify({
        a: null,
        b: ''
      }, {strictNullHandling: true})).to.equal('a&b=');
    ...
    it('can sort the keys', function(done) {
      ...
      expect(Qs.stringify({
        ...
        z: 'y',
        b: 'f'
      }, {sort: sort})).to.equal('a=c&b=f&z=y');
      expect(Qs.stringify({
        a: 'c',
        z: {
          j: 'a',
        ...
        b: 'f'
      }, {sort: sort})).to.equal('a=c&b=f&z%5Bi%5D=b&z%5Bj%5D=a');
      done();
    });
  });
  return {};
});
System.get("../../../../../../node_modules/fsevents/node_modules/qs/test/stringify.js" + '');
