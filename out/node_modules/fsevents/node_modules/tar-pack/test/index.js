System.registerModule("../../../../../../node_modules/fsevents/node_modules/tar-pack/test/index.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/tar-pack/test/index.js";
  var tar = require('../');
  ...
  describe('pack(directory).pipe(tarball)', function() {
    it('packs the directory into the output', function(done) {
      ...
      tar.pack(__dirname + '/fixtures/to-pack').pipe(write(__dirname + '/output/packed.tar.gz')).on('error', function(err) {
        if (called)
          return;
        called = true;
        done(err);
...
System.get("../../../../../../node_modules/fsevents/node_modules/tar-pack/test/index.js" + '');
