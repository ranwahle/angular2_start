System.registerModule("../../../../../../node_modules/fsevents/node_modules/tar/test/pack.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/tar/test/pack.js";
  var fs = require("fs"),
      path = require("path"),
  ...
  function runTest(t, doGH, doFromBase) {
    ...
    parse.on("*", function(ev, e) {
      ...
      if (doFromBase) {
        ...
        if (wanted[1])
          wanted[1].path = wanted[1].path.replace('fixtures/', '').replace('//', '/');
        if (wanted[1].path == '')
          wanted[1].path = '/';
        if (wanted[2] && wanted[2].path)
          wanted[2].path = wanted[2].path.replace('fixtures', '').replace(/^\//, '');
...
System.get("../../../../../../node_modules/fsevents/node_modules/tar/test/pack.js" + '');
