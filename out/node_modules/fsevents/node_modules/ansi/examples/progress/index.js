System.registerModule("../../../../../../../node_modules/fsevents/node_modules/ansi/examples/progress/index.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../../node_modules/fsevents/node_modules/ansi/examples/progress/index.js";
  ...
  function set(v) {
    ...
    this.cursor.horizontalAbsolute(0).eraseLine(2).fg.white().write(this.open).fg.grey().bold().write(com).resetBold().write(inc).fg.white().write(this.close).fg.reset().write('\n');
  }
  ...
  (function tick() {
    ...
    p.cursor.eraseLine(2).write('Progress: ').bold().write(p.progress.toFixed(2)).write('%').resetBold().write('\n');
    if (p.progress < 100)
      setTimeout(tick, 100);
  })();
  return {};
});
System.get("../../../../../../../node_modules/fsevents/node_modules/ansi/examples/progress/index.js" + '');
