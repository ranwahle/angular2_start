System.registerModule("../../../../../../node_modules/fsevents/node_modules/hawk/test/client.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/hawk/test/client.js";
  var Url = require('url');
  ...
  describe('Client', function() {
    ...
    describe('authenticate()', function() {
      it('returns false on invalid header', function(done) {
        var res = {headers: {'server-authorization': 'Hawk mac="abc", bad="xyz"'}};
    ...
    describe('message()', function() {
      ...
      it('errors on invalid host', function(done) {
        ...
        var auth = Hawk.client.message(5, 80, 'I am the boodyman', {
          credentials: credentials,
          timestamp: 1353809207,
          nonce: 'abc123'
        });
      ...
      it('errors on missing host', function(done) {
        ...
        var auth = Hawk.client.message('example.com', 0, 'I am the boodyman', {
          credentials: credentials,
          timestamp: 1353809207,
          nonce: 'abc123'
        });
      ...
      it('errors on null message', function(done) {
        ...
        var auth = Hawk.client.message('example.com', 80, null, {
          credentials: credentials,
          timestamp: 1353809207,
          nonce: 'abc123'
        });
      ...
      it('errors on missing message', function(done) {
        ...
        var auth = Hawk.client.message('example.com', 80, undefined, {
          credentials: credentials,
          timestamp: 1353809207,
          nonce: 'abc123'
        });
      ...
      it('errors on invalid message', function(done) {
        ...
        var auth = Hawk.client.message('example.com', 80, 5, {
          credentials: credentials,
          timestamp: 1353809207,
          nonce: 'abc123'
        });
...
System.get("../../../../../../node_modules/fsevents/node_modules/hawk/test/client.js" + '');
