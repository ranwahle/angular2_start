System.registerModule("../../../../../../node_modules/fsevents/node_modules/hawk/test/uri.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/hawk/test/uri.js";
  ...
  describe('Uri', function() {
    ...
    it('should fail on invalid host header', function(done) {
      var req = {
        ...
        headers: {host: 'example.com:something'}
      };
      Hawk.uri.authenticate(req, credentialsFunc, {}, function(err, credentials, attributes) {
        expect(err).to.exist();
    ...
    describe('getBewit()', function() {
      ...
      it('returns a valid bewit value (explicit port)', function(done) {
        ...
        var bewit = Hawk.uri.getBewit('https://example.com:8080/somewhere/over/the/rainbow', {
          credentials: credentials,
          ttlSec: 300,
          localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(),
          ext: 'xandyandz'
      ...
      it('returns a valid bewit value (parsed uri)', function(done) {
        ...
        var bewit = Hawk.uri.getBewit(Url.parse('https://example.com/somewhere/over/the/rainbow'), {
          credentials: credentials,
          ttlSec: 300,
          localtimeOffsetMsec: 1356420407232 - Hawk.utils.now(),
          ext: 'xandyandz'
...
System.get("../../../../../../node_modules/fsevents/node_modules/hawk/test/uri.js" + '');
