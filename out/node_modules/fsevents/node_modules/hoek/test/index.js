System.registerModule("../../../../../../node_modules/fsevents/node_modules/hoek/test/index.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/hoek/test/index.js";
  var Fs = require('fs');
  ...
  describe('deepEqual()', function() {
    ...
    it('compares empty arguments objects', function(done) {
      var compare = function() {
        var arg1 = arguments;
        var inner = function() {
          expect(Hoek.deepEqual(arg1, arguments)).to.be.false();
        };
        inner();
      };
      compare();
  ...
  describe('contain()', function() {
    it('tests strings', function(done) {
      ...
      expect(Hoek.contain('abc', ['ab', 'bc'])).to.be.false();
      done();
    });
    ...
    it('tests objects', function(done) {
      ...
      expect(Hoek.contain({
        ...
        a: [1],
        c: [3]
      }, {deep: true})).to.be.true();
      expect(Hoek.contain({a: [{b: 1}, {c: 2}, {
          d: 3,
          e: 4
        }]}, {a: [{b: 1}, {d: 3}]}, {deep: true})).to.be.true();
      expect(Hoek.contain({a: [{b: 1}, {c: 2}, {
          d: 3,
          e: 4
        }]}, {a: [{b: 1}, {d: 3}]}, {
      ...
      expect(Hoek.contain({a: new Foo('b')}, {a: new Foo('b')}, {
        deep: true,
        part: true
      })).to.be.true();
      expect(Hoek.contain({a: new Foo('b')}, {a: {baz: 'b'}}, {deep: true})).to.be.true();
      expect(Hoek.contain({a: new Foo('b')}, {a: {baz: 'b'}}, {
        deep: true,
        only: true
      })).to.be.false();
      expect(Hoek.contain({a: new Foo('b')}, {a: {baz: 'b'}}, {
  ...
  describe('assert()', function() {
    ...
    it('throws the same Error that is passed to it if there is only one error passed', function(done) {
      ...
      try {
        ...
        expect(error).to.not.equal(error2);
      }
      done();
    });
  });
  ...
  describe('transform()', function() {
    ...
    it('only allows strings in the map', function(done) {
      expect(function() {
        var result = Hoek.transform(source, {lineOne: {}});
...
System.get("../../../../../../node_modules/fsevents/node_modules/hoek/test/index.js" + '');
