System.registerModule("../../../../../../node_modules/fsevents/node_modules/gauge/test/progress-bar.js", [], function() {
  "use strict";
  var __moduleName = "../../../../../../node_modules/fsevents/node_modules/gauge/test/progress-bar.js";
  ...
  function isOutput(t, msg, output) {
    ...
    tests.forEach(function(test) {
      t.is(cursor[test.cmd] ? cursor[test.cmd][test.arg] : null, output[test.cmd][test.arg], msg + ": " + output[test.cmd] + (test.arg ? " arg #" + test.arg : ""));
    });
  }
  test("hide", function(t) {
    ...
    bar.hide();
    isOutput(t, "hide while not showing", [["show"], ["horizontalAbsolute", 0], ["eraseLine"]]);
    cursor = [];
    bar.showing = true;
    bar.hide();
    isOutput(t, "hide while showing", [["show"], ["up", 1], ["horizontalAbsolute", 0], ["eraseLine"]]);
  });
  test("renderTemplate", function(t) {
    ...
    var result = bar.renderTemplate(ProgressBar.ascii, [{type: "name"}, {type: "completionbar"}], {
      name: "NAME",
      completed: 0.5
    });
    ...
    var result = bar.renderTemplate(ProgressBar.ascii, [{
      type: "name",
      separated: true
    }, "static"], {name: "NAME"});
    t.is(result, "NAME static", "post-separated");
    var result = bar.renderTemplate(ProgressBar.ascii, ["1", {
      type: "name",
      separated: true
    }, "2"], {name: ""});
  ...
  test("show & pulse", function(t) {
    ...
    bar.last = new Date(0);
    bar.show("NAME", 0.1);
    isOutput(t, "tty, name, completion", [['hide'], ['horizontalAbsolute', 0], ['write', 'NAME   |#-----|\n'], ['show']]);
    bar.show("S");
    cursor = [];
    bar.last = new Date(0);
    bar.pulse();
    isOutput(t, "pulsed spinner", [['up', 1], ['hide'], ['horizontalAbsolute', 0], ['write', 'S      \\ |----|\n'], ['show']]);
    cursor = [];
    bar.last = new Date(0);
    bar.pulse("P");
    isOutput(t, "pulsed spinner with subsection", [['up', 1], ['hide'], ['horizontalAbsolute', 0], ['write', 'S -> P | |----|\n'], ['show']]);
  });
  test("window resizing", function(t) {
    ...
    bar.last = new Date(0);
    bar.pulse();
    isOutput(t, "32 columns", [['up', 1], ['hide'], ['horizontalAbsolute', 0], ['write', 'NAME   / |##------------------|\n'], ['show']]);
    process.stdout.columns = 16;
    bar.show("NAME", 0.5);
    cursor = [];
    bar.last = new Date(0);
    bar.pulse();
    isOutput(t, "16 columns", [['up', 1], ['hide'], ['horizontalAbsolute', 0], ['write', 'NAME   - |##--|\n'], ['show']]);
  });
  return {};
});
System.get("../../../../../../node_modules/fsevents/node_modules/gauge/test/progress-bar.js" + '');
